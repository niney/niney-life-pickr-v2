...
// 빌드는 apps/friendly/scripts/build-saju-images.ts 가 1:1 webp 512/1024 로 apps/web/public/saju-c/images/ 에 만든다.
...
export const SAJU_IMAGE_BASE_PATH = '/saju-c/images';
