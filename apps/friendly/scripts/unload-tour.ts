// 여행로그(AI 허브 71780·71779·71778·71581) 폐기 — Tour* 테이블 10개 + 맛집 매칭(RestaurantTourMatch)·사업자 상태(TourPlaceBizStatus)를
...
//
// 실행: pnpm --filter friendly unload:tour --yes [--dataset jeju|west|east|capital]   (--dataset 없으면 전부)
