...
export type SajuPanelTab = 'chart' | 'personality' | 'elements' | 'cycle' | 'year' | 'daily' | 'date' | 'love' | 'wealth' | 'career' | 'food';
...
export const SAJU_PANEL_GROUPS: ReadonlyArray<{ id: SajuPanelGroup; label: string; tabs: ReadonlyArray<{ id: SajuPanelTab; label: string; tool?: boolean }> }> = [
  ...
  { id: 'theme', label: '테마', tabs: [{ id: 'love', label: '인연' }, { id: 'wealth', label: '재물' }, { id: 'career', label: '직업' }, { id: 'food', label: '음식', tool: true }] },
];
