...
import { SAJU_ELEMENTS, SAJU_ELEMENT_META, type SajuElementId } from '@repo/utils';

function Instrument({ active, revealing }: { active: SajuElementId | null; revealing: boolean }) {
...
export default function SajuStage({
  active,
  revealing,
  visible,
}: {
