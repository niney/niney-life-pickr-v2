...
// 별도 컴포넌트로 뽑는 건 disabled/스피너/안내 분기를 본체 JSX 에서 떼어
// 가독성 유지.
//
// 'denied'(권한 차단)는 사용자가 브라우저 사이트 설정에서 직접 풀 수 있으므로
// 버튼을 비활성하지 않고, 클릭하면 해제 방법 callout 을 띄운다. 클릭 시 refetch
// 도 같이 걸어, 사용자가 이미 설정을 풀어둔 경우 즉시 재시도되게 한다. (설정을
// 푸는 즉시 useUserLocation 의 permission 'change' 구독이 자동 반영하므로,
// 클릭조차 안 해도 버튼은 살아난다.)
