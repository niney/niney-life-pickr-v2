...
sources_count: 155
status: active
aliases: [monorepo, life-pickr, niney, root, turbo, pnpm-workspace, tarot, 타로, tarot-reading, menu-tarot, saju-c, 사주(C), saju, saju-g, 사주(G), two-implementations-c-g, 사주-두-구현, housing, 집값, 실거래가, RTMS, K-apt, 공시가격, usage-quota, 사용량-한도, anonymous-quota, guest-key, X-Guest-Key, resolveOptionalUser, embed-mode, webview-embed, embedBridge, lp:embed, webUrl, EXPO_PUBLIC_WEB_URL, DATA_GO_KR_API_KEY, data-go-kr-key-unified, HOUSING_REFRESH_CRON, deploy-case-8, ops-nginx, nginx-try-files, spa-directory-conflict, absolute_redirect, OLLAMA_TAROT_MODEL, OLLAMA_SAJU_MODEL, OLLAMA_SAJU_G_MODEL, kimi-k3, three-vendor-chunk, R3F, satori-share-image, web-index, share-fonts, saju-glyphs, assets-src, useSchemaDatabase, menu-calorie, kcalPer100g, menu-lexicon, menu-nutrition, admin-quotas, air-quality, 대기질, airkorea, 에어코리아, weather, 날씨, kma, 기상청, kma-apihub, API허브, life-map, 일상지도, cctv, public-toilet, 공중화장실, hospital, 병의원, hira, 심평원, food-catalog, 음식-카탈로그, meal, 식단, meal-recognition, meal-recommend, data-open, data-sources, open-data-raw, 공공데이터-원본, loader-default-path, deploy-case-6, deploy-case-7, status-script, life-map-status, food-catalog-status, geocode-cache-gz, data-go-kr-key-fallback, BUS_API_KEY-fallback, 활용신청, useIsolatedDatabase, test-isolation, prebuilt-rncore, ios-link-error, mobile-ios-build, personal-team-entitlements, aps-environment, hermes-sharedarraybuffer, metro-monorepo-default, expo-document-picker, topbar-width-budget, account-menu, sidebar-account, my-location-chip, sheet-pattern, useMapSheets, useIsDesktopXl, wiki-sync, settlement, 정산, settlement-domain, share-token, public-share-read, ai-purpose, vision-llm, receipt-extraction, contacts-page, settlement-stepper, edited-badge, admin-discover, admin-auto-discover, panel-side-toggle, batch-crawl, naver-search-results, panelPrefsStore, captcha-aware-capture, mobile-ux, body-scroll, sticky-containing-block, terminology, web-mobile-app, expo-web, diningcode, catchtable, tabling, 테이블링, canonical-restaurant, multi-source, four-source, auto-dc-merge, place-partner-promotion, sse-heartbeat, stale-summary-cleanup, crawl-job-log, operation-log, operation-run, log-analysis, log-retention, summary-queued-cancelled, summary-resume, app-level-singleton-plugin, mobile-native-tabs, dev-client, webview-vworld, location-first-entry, public-reviews-pagination, naver-stealth, db-path-unified, mobile-production-build, settlement-rounds, settlement-group-split, drink-kinds, glasses-split, settlement-draft-auto-save, universal-links-iOS, app-links-android, well-known-AASA, well-known-assetlinks, RFC1918-dev-cors, dev-cors-reflect-all, cors-preflight-fix, expo-web-lan-ip, multi-receipt-split, roundUnit-100-1000, refinement-leftover, ai-models-preview, settlement-PUT-full-replace, items-mutable-after-save, tailwind-v4-dark-fix, deep-link-fallback, share-settlements-deep, settlement-mobile-implementation, attendees-100, items-200, EXTRACTION_VERSION, headerBackTitle-fix, sticky-breakdown-z-30, tab-bar-inset, useTabBarHeight, awesome-gallery, lightbox-portal, home-ranking-link, public-reviews-sort-fix, share-og-ssr, ssr-lite-head-injection, restaurant-share-r, restaurant-seo, sitemap, json-ld, og-image-png, settlement-card-png, share-preview, restaurant-preview, panorama-cache, eslint-infra, turbo-lint, deploy-sh, ninelife-kr, nginx-caret-tilde, cloudflare-purge, vite-codesplitting, route-lazy, react-memo-hotpath, ibmplexsanskr, schedule, schedule-config, schedule-run, croner, normalize-merge-cron, in-process-scheduler, random-crawl, 맛집-자동-발굴, telegram-bot, telegram-discover, telegram-stats, telegram-search, force-reply, review-search, rag, 리뷰-문맥검색, enrich, hybrid-retrieval, review-clustering, 리뷰-군집화, umap, hdbscan, python-sidecar, canonical-corpus, llm-telemetry, concurrency-gate, account-gate, db-config-env-fallback, region-stats, choropleth, sigungu-geo, smart-pick, taxonomy-v3, ingredient-menu-group, GLOBAL_MERGE_VERSION-3, dark-mode, theme-mode, lp-themeMode, vworld-midnight, satellite-layer, android-custom-tabbar, splash-logo-fix, expo-prebuild-cleanup, soft-tonal, menu-thumbnail-lightbox, card-click-map, double-click-zoom, category-tree-shared, categoryPath-recovery, ollama-grammar-array, bus, 버스, bus-stations, bus-arrivals, bus-route, bus-positions, bus-favorite, seoul-bus-api, public-transit, tour, 여행로그, tour-log, travel, 여행, aihub, AI허브, AI-Hub, 71780, 71779, 71778, 71581, lp-2023, lp-west-2023, lp-east-2023, lp-capital-2023, tour-c, niney-tour-pickr, TOUR_DATASETS, TOUR_REGIONS, TOUR_REGION_KEYS, TOUR_DATASET_KEYS, TOUR_RAW_USER_IDS, TOUR_THUMBS_DIR, load:tour, unload:tour, match:restaurant-tour, check:tour-biz, e2e:tour, dataset-replace, 데이터셋-단위-교체, id-prefix, plausibility, jeju-share, region-filter, tour-region-filter, hubLabel, travel-insights, travel-plan, /travel/jeju, /travel/plan, admin-tour, tour-seeds, 여행로그-시드, tour-raw, raw-allowlist, 원본-열람, no-store-noindex, tour-density, traveler-density, 여행자-밀도, TourPlace, TourTrip, TourVisit, RestaurantTourMatch, TourPlaceBizStatus, biz-status, 폐업-조회, 15081808, k-anonymity, small-cell-suppression, 소셀-억제, TOUR_K_MIN, TOUR_SOURCE_NOTE, 출처-표기, aihub-license, 이용조건, 공개-노출-게이트, 국외-반출-금지, one-db-two-exits, 한-DB-두-출구, deploy-tour-loop, 세트-루프, tour_jeju, background-overlay, 배경-레이어, LIFE_MAP_OVERLAYS, crime-overlay, 범죄-통계, life-crime, build:life-crime, 3074462, sigungu-geo-overlay, life-store, 상가정보, 생활편의, LifeStore, load:life-stores, match:restaurant-stores, RestaurantStoreMatch, StoreInfoBadges, 15083033, housing-infra, 생활-인프라, saju-themes, 사주-테마, saju-ask, 사주에-묻기, SajuPairPanel, sajuPanelTabs, llm-thinking, thinking, kimi-thinking, thinkOptionFor, 추론, deploy-case-6-force, store-zip-set-e, rsync-export, 백업-대상, sea, 바다, /sea, khoa, 국립해양조사원, 생활해양예보지수, 물때, 조석예보, 이안류, 15142484, 15156018, 15156028, parking, 주차, /parking, 주차장, 전기차-충전소, ev-charger, 공항-주차, 15012896, 15076352, 15158689, 15095047, KOTSA-15099883, PARKING_LIVE_CRON, EV_STATUS_CRON, SEOUL_OPEN_API_KEY, parking_data, deploy-case-9, status:parking, load:parking-lots, load:ev-chargers, lp:parking-prefs, onListen-poller, 폴러-onListen, dev-poller-double-quota, flood, 침수-흔적, 침수흔적도, OA-15636, load:life-flood, LifeFloodTrace, data-open-flood, flood-auto-download, utmk, EPSG-5179, api-docs, 외부-API-문서, docs/api, openapi.json, endpoints.md, export:openapi, OPTIONAL_BEARER, x-auth, x-rate-limit, cors-open, CORS-개방, credentials-false, CORS_ORIGIN-star, security-42-reversal, #42-번복, claude-md-rule-6, CLAUDE.md-6번, app-level-test, app.cors.test, app.openapi.test, app.errors.test, plugins-no-test, rate-limit-429-body, naver-placeMenus, 네이버-메뉴-개편, backfill:naver-menus, menu-zero-guard, 메뉴-0건-보호, admin-restaurant-detail, 어드민-맛집-상세, review-match, summaryChannelKey, canonical-summary-ops, hookTimeout, test-hook-timeout-60s, cleanupStaleReviewSummaries-isolation, nav-14, topbar-nav-13, 27차]
---

# project-overview — 모노레포 개요

**2026-09-24~09-26 변경 흡수 (27차) — 새 도메인 둘(바다 `/sea`·주차 `/parking`) + 집값 침수 흔적 + 외부 공개 API(어드민 외 CORS `*`·`docs/api` 자동 생성·CLAUDE.md 6번 규칙) + 네이버 메뉴 개편 대응 + 어드민 맛집 상세 재구성**: 3일·8커밋·156파일(+69,643/−1,240 — 그중 생성물 `docs/api/openapi.json` 51,599줄, 빼면 155파일 +15,724/−1,240). (1) **바다 `/sea`**([sea](sea.md) — 신규 토픽, `4a2bff1` 2026-09-24): 국립해양조사원 생활해양예보지수 6종(해수욕·서핑·바다낚시·갯벌체험·바닷길·바다여행)의 7일 오전/오후 5단계 지수를 지도 마커색·순위로, 지점 상세에 7일 지수 띠·어종/등급 `variants`·이안류(6~9월)·가장 가까운 조석 예보지점의 만조/간조. friendly `modules/sea` 가 data.go.kr **8개 데이터셋**(15142484·15142490·15142486·15142489·15142485·15142491 + 조석 15156018 + 이안류 15156028)을 **적재 없이 프록시**(활동별 전량 1시간·물때 지점×날짜 12시간 메모리 캐시 + 업스트림 실패 시 12시간 stale)하고, 코드표에 없는 지점 좌표(조석 166·이안류 10)는 지점별 1회 호출로 모아 utils `seaStations.ts` 에 커밋. 날씨의 해상 중기예보(`/weather` `?sea=`)와는 별개 원천. (2) **주차 `/parking`**([parking](parking.md) — 신규 토픽, `2ff2c31` 2026-09-25, [docs/PLAN-parking.md](../../docs/PLAN-parking.md)): 일상지도 레이어가 아니라 **별도 메뉴**(대중교통 다음) — 지도 + 패널, 탭 주차장|충전소|공항. 주차장은 전국주차장정보표준데이터 15012896 + 서울 공영주차장(`GetParkInfo`, `SEOUL_OPEN_API_KEY`)을 `ParkingLot` 18,168곳(로컬 실측)으로 적재해 요금·운영시간·1~3시간 예상 요금, 서울 시영 실시간 여석과 공항(한국공항공사 15158689 13곳 + 인천공항 15095047)은 **5분 폴러**(`PARKING_LIVE_CRON`)가 메모리에 두고 요일×시간 혼잡 이력(`ParkingOccupancyStat`)에 누적, 전기차 충전소(환경공단 15076352) 99,850곳·충전기 515,263기는 적재 + **10분 상태 폴러**(`EV_STATUS_CRON`). 폴러는 **`onListen` 에서만 시작**(`export:openapi`·inject 테스트가 업스트림을 부르지 않게 — [server-only-boot-effects](../concepts/server-only-boot-effects.md)). 맛집 상세 '가는 법' 탭에 주차 섹션(리뷰 '주차' 관점·팁·다이닝코드 시설·반경 300m 주차장) + 홈 탭 한 줄 요약. KOTSA 주차정보 15099883 은 심의 대기. (3) **집값 침수 흔적**([housing](housing.md)·[life-map](life-map.md), `ad48f96` 2026-09-24): 서울 열린데이터 OA-15636 침수흔적도 연도별 SHP 14개(2010~2025) 43,112 필지를 무게중심 점 `LifeFloodTrace` 로 적재해 단지 반경 100m 건수·최대 침수심·사건 연월별 내역 + 지도 배지 물방울(1~4건 흰 원 / 5건↑ 파란 원). 주소·필지는 저장·노출하지 않고, 흔적이 없는 시도(서울 밖)는 0 이 아니라 `null`. UTM-K(EPSG:5179)↔WGS84 변환은 utils 에 직접, SHP/DBF 파서는 집값 공시가격 zip 리더를 재사용 — **새 의존성 0**. `load:life-flood` 는 `data/open/flood/` 가 비면 서울 열린데이터에서 **로그인 없이 자동 다운로드** — 원본을 손으로 올리지 않는 첫 파일 적재. 일상지도 화면엔 침수 레이어가 없다(적재 마스터·`status:life-map` `flood=N` 만 life-map 소속). (4) **외부 공개 API**([api-docs](api-docs.md) — 신규 토픽, `678ecc0`·`1b621c4` 2026-09-24): 사용자의 다른 프로젝트가 브라우저에서 직접 쓰도록 어드민(`/api/v1/admin/**`) 외 CORS 를 `origin: '*'` + **`credentials: false`** 로 개방(어드민은 `PUBLIC_ORIGIN` 만) — 2026-06 보안 감사 #42 fail-closed 결정의 **번복**([docs/PLAN-perf-security.md](../../docs/PLAN-perf-security.md)). `plugins/swagger.ts` 스펙 생성기를 전 환경 등록(HTTP 미노출, `/docs` UI 는 dev 만)하고 transform 이 `x-auth`·`x-rate-limit`·bearer security 를 자동 부착, `export:openapi` 가 [docs/api/](../../docs/api/README.md) `openapi.json`·`endpoints.md` 를 생성(`1b621c4` 183개 → `2ff2c31` 재생성 **192개: 공개 83·선택 15·로그인 94**, `420a6be` 재생성 변화 없음) + 수기 `README.md`. 비-어드민 라우트 30여 파일에 한국어 `summary` 일괄, 선택 인증 15개는 `security: OPTIONAL_BEARER`. CLAUDE.md 에 **핵심 규칙 6번**(summary·OPTIONAL_BEARER·`export:openapi` 재생성·`src/plugins/` 에 `*.test.ts` 금지 → `src/app.*.test.ts`)이 생겼다. 429 본문 `error` 누락 수정(`678ecc0`). (5) **맛집 운영**: 네이버 플레이스가 메뉴 Apollo 구조를 `placeMenus` 로 바꿔(2026-09-13~25 사이) 비배민 가게 메뉴가 에러 없이 0건이 되던 것을 파서 교체·**0건 보호**(직전 스냅샷 유지 + warn)·`/menu/list` 조건부(크롤 9→4초)·`backfill:naver-menus` 로 대응(`43d7e69` 2026-09-25, [crawl](crawl.md)·[menu-grouping](menu-grouping.md) — 운영은 배포 후 백필). 어드민 맛집 상세를 공개 상세 탭 구성(홈·분석·여행자·메뉴·리뷰·질문·사진·정보·로그, `?tab=`)으로 재구성하고 리뷰 목록·요약 운영(중지·재개·재분석)을 **canonical 전체 출처**로 넓혔다(`420a6be` 2026-09-26 — 기존 엔드포인트 의미 변경, 요약 채널 키 `summaryChannelKey` 통일 등 기존 버그 4건 동반 수정, [canonical](canonical.md)). (6) **테스트·규모**: `vitest.config.ts` `hookTimeout` 60초(격리 DB 가 dev.db 3.6GB 를 통째 복사)·meal-recognition FK 실패 수정(`5d7b686`), `cleanupStaleReviewSummaries` 테스트가 실 dev.db 의 대기 요약을 failed 로 뒤집던 **두 번째 격리 사고** 수정(`420a6be`). friendly 모듈 40→**42** · api-contract 스키마 44→**46** · Prisma 모델 107→**113**(+6) · 마이그레이션 86→**88**(둘 다 `CREATE TABLE` 만) · friendly 스크립트 파일 87→**93**(package 스크립트 101→**107**) · 테스트 파일 203→**219**(friendly 143·web 29·shared 13·utils 34·앱 0) · `useIsolatedDatabase()` 26→**28**파일 — 새 npm 의존성 없음. 커밋 본문 실측: friendly 1,483(`43d7e69`) → 1,508(`2ff2c31`, 무관 2파일 실패) → **1,522·143파일**(`5d7b686`) → **1,530 통과·1 skip**(`420a6be`), web 145→**149**, utils **389**, shared 81, typecheck 6/6. 공개 메뉴 13개 + 로그인 시 식단 = NAV **14**(홈·맛집·대중교통·**주차**·일상지도·집값·여행·날씨·**바다**·대기질·타로·사주(C)·사주(G)·식단). 앱 변경 0 — 주차·바다는 앱 미구현.

**2026-09-12~09-19 변경 흡수 (26차) — 새 도메인 여행로그(AI 허브 「국내 여행로그 데이터」 4권역 → "집계는 공개, 원본은 관리자, 계약은 export 하나") + 일상지도 배경(면) 레이어 2종·상가정보 3종 + 사주(C) 8·9차·추론 선택 + 운영 규약(데이터셋 단위 교체·deploy 세트 루프·원본 allowlist)**: 8일·14커밋·176파일(+18,177/−531). (1) **여행로그 `tour`**([tour](tour.md) — 신규 토픽, `c777380`·`99991da`·`9196495`·`8c27f5c`·`cfa276b`·`b9da676` 2026-09-13 → `d18ac24` 09-16 → `93ae031`·`6cae6b2` 09-19): AI 허브 2023 패널 여행로그 4권역 — 제주·도서 **71780**(export `lp-2023`, 장소 15,679) · 서부권 **71779**(`lp-west-2023`, 11,516, 장소 id 접두 `west:`) · 동부권 **71778**(`lp-east-2023`, 12,531, `east:`) · 수도권 **71581**(`lp-capital-2023`, 10,545, `capital:`) — 합계 장소 **50,271**·여행 11,520(세트당 2,880). 변환기(Python/DuckDB `niney-tour-pickr/tour-c*`)는 **리포 밖**이고 이 리포는 export(JSONL.gz 10표 + manifest sha256 + 256px webp 썸네일)를 `load:tour --dataset` 으로 **데이터셋 단위 전량 교체** 적재해 `Tour*` 10표(FK 없음, `dataset` 열)에 둔다. 구조는 **"한 DB, 두 출구"** — 공개 API(`/tour/public/{insights,plan,density,lodging,regions}`·`/restaurants/public/:placeId/tour-stats`·목록 `sort=tourTravelers|tourScore`·골라줘 `strategy: 'traveler'`)는 응답 스키마에 여행·방문·여행자 식별자가 없는 **집계만**(소셀 억제: 여행자 <5 셀 null·평점 3건 미만 null·여행 <20 이면 `insufficient`, 테스트가 응답 키를 스캔), 원본(개별 방문·주문 원문·영수증·사진·여행 타임라인)은 `/admin/tour/places/*`·`trips/*`·`photos/*` 가 **`TOUR_RAW_USER_IDS` allowlist(본인 user id 또는 이메일) 밖이면 404** + `private, no-store`·`X-Robots-Tag: noindex`. 사이에 맛집 `canonical` ↔ 여행로그 장소 1:1 매칭(`RestaurantTourMatch`, 100m·상호 점수 ≥0.5 / 완전일치 300m)과 국세청 폐업 조회(`TourPlaceBizStatus`, data.go.kr 15081808 100건/콜)·어드민 시드 콘솔 `/admin/tour`(여행자 많이 간 미등록 식당 → 네이버 검색 discover → 기존 크롤 잡 register → 매칭 자동). 웹은 `/travel/jeju`(인사이트 — 필터 = URL 쿼리, 지역 21키 칩 2행 권역→시도)·`/travel/plan`(코스 추천 → `/vote/new` `location.state` 프리필)·상세 "여행자" 탭·일상지도 배경 "여행자 밀도"(0.02° 격자, 여행자 ≥5 칸)·공개 메뉴 "여행"(NAV 11개). 실서버 e2e 스크립트 `e2e:tour`(playwright 크로미움 32 step — 계약·소셀·무인증 차단·화면·모바일 폭·콘솔 오류). **이용조건 게이트** — AI 허브 원본 재배포·국외 반출 금지, 공개는 집계·2차 저작물 + 출처 표기(`TOUR_SOURCE_NOTE` 가 데이터명 4개를 자동 나열)이고 "학습용으로만" 조항 vs FAQ "서비스 2차 저작물 자유" 문언 충돌이 있어 **공개 화면(/travel/*·여행자 탭·밀도)은 AI 허브 서면 회신 전 운영 노출 금지**([docs/PLAN-tour-log.md](../../docs/PLAN-tour-log.md) 부록 B 문의문에 4 데이터셋). 4권역이 끝나 후속은 **앱 연동뿐**(앱에 여행로그 화면 없음). (2) **일상지도에 "배경(면) 레이어" 유형 신설**([life-map](life-map.md), `bc39a79` 2026-09-12 + `9196495`): 경찰청 범죄 발생 지역별 통계(3074462) 시군구 229곳 인구 10만 명당 강력/절도/폭력 5등급 — DB·마이그레이션 없이 **`build:life-crime` 산출 JSON(66KB)을 리포에 커밋**하는 새 변형(인구 CSV 는 행안부에서 자동 다운로드) — 과 여행자 밀도, 배경은 한 번에 하나(배타). 소상공인 상가(상권)정보(15083033, 분기 zip 353MB → `LifeStore` 1,307,626행 스트리밍 적재, 관심 업종 9종)로 **생활편의 점 레이어**(편의점·마트·약국·세탁·동물병원·미용실) + 맛집↔상가 매칭(`RestaurantStoreMatch` 80m·상호 0.5 — 업종·폐업 의심 배지) + 집값 단지 반경 500m 생활 인프라 세 곳에 쓴다. (3) **사주(C) 8·9차 + 추론**([saju-c](saju-c.md), `739705e`·`baecb9b`·`a823af1` 2026-09-12): 테마 3종(인연·재물·직업)·풀이 탭 그룹 3×서브 재편·궁합 입구 모드, "사주에 묻기"(만약에 이랬다면 — 주제 9·시점 4·차단 키워드는 정적 답, 타로 연동 `?q=&topic=`), 어드민에서 kimi 모델 전용 **추론(thinking) 5단계** 선택(`LlmProviderConfig.thinking`, 기본 끔 — 켜면 p50 12→29s·출력 토큰 5배, [ai](ai.md)). (4) **운영 규약** — `data/open/tour/<export>/`(세트당 ~190MB, git 밖, **rsync 반입**, 재취득이 어려워 **백업 대상**)·`data/open/store/`·`data/open/crime/` 가 [docs/data-sources.md](../../docs/data-sources.md) 보관표에 합류(tour 4행·store·crime 2행); `deploy.sh` 는 API 배포(1·2·4)마다 상가 zip 적재·매칭에 더해 여행로그를 **"키|폴더|이름" 세트 루프**로 `tour_<세트>=0` 인 것만 적재 후 매칭 한 번(`status:life-map` 이 `tour=N tour_jeju=… tour_west=… tour_east=… tour_capital=… tour_matched=X`), 케이스 6 은 force 라 여행로그만 넣을 땐 쓰지 않는다(`cfa276b`), 상가 zip 탐지가 파일 없을 때 `set -e` 로 조용히 죽던 것 수정(`127e746`); `.env` 신규 `TOUR_RAW_USER_IDS`·`TOUR_THUMBS_DIR(_WEST|_EAST|_CAPITAL)`, `DATA_GO_KR_API_KEY` 에 15081808 활용신청; 원본은 **국내 서버**에만, 관리자 원본 화면은 Cloudflare 프록시를 거치지 않는 경로(DNS 전용 서브도메인·`ssh -L`) 권장([docs/deploy-friendly.md](../../docs/deploy-friendly.md) 여행로그 절). (5) 규모 — friendly 모듈 39→**40** · api-contract 스키마 43→**44** · Prisma 모델 93→**107**(+14) · 마이그레이션 80→**86**(+6 — `dataset` 열 추가·FK 제거는 SQLite `RedefineTables` 테이블 재생성, thinking 은 `ADD COLUMN`) · friendly 스크립트 파일 78→**87**(package 스크립트 92→**101**, `match:`·`check:`·`unload:`·`e2e:` 접두 신설) · 테스트 파일 184→**203**(friendly 134·web 25·shared 13·utils 31·앱 0), `useIsolatedDatabase()` 17→**26**파일. 커밋 본문 실측: 2026-09-19 friendly tour 45·utils tourLog 7·web 132·`e2e:tour` 32/32, 2026-09-12 사주 9차 시점 web 127·utils 355·shared 81. 공개 메뉴 11개(홈·맛집·대중교통·일상지도·집값·**여행**·날씨·대기질·타로·사주(C)·사주(G) + 로그인 시 식단), 앱 변경은 일상지도 생활편의 표시·홈 사주 카드 "사주에 묻기" 버튼뿐(탭 4개 + 홈 카드 4장 그대로).
...
선택이 고민될 때 대신 골라주는 서비스다. 핵심 도메인은 일곱 축으로 갈린다 — 선택 도우미·맛집 분석·정산(원래 세 축)에 2026-07 대중교통, 2026-08 생활정보·식단, 2026-09 **운세·선택 놀이(타로·사주)**, 2026-09-13 **여행로그(AI 허브 여행 통계 — 공개는 집계·원본은 관리자)** 가 더해졌다. 2026-09-24~25 에는 생활정보 축에 **바다·주차** 두 페이지가 합류했다(축 수는 그대로 일곱). 그리고 같은 날 백엔드가 이 서비스 밖의 **다른 프로젝트에도 공개 API 로 열렸다**(아래 "클라이언트" 목록의 네 번째 소비자):
...
- **맛집 분석** — 어드민이 다양한 출처에서 식당을 크롤링하고 리뷰를 LLM으로 분석해 메뉴 통계 트리까지 빌드한다 ([crawl](crawl.md), [ai](ai.md), [menu-grouping](menu-grouping.md), [analytics](analytics.md)). 출처는 4종 — **네이버 플레이스 / 다이닝코드 / 캐치테이블 / 테이블링**(18차 합류). 어드민의 진입 경로는 네 갈래 — 단건 placeId 입력 (`/admin/restaurants`), 키워드 검색→다중 선택 일괄 등록 (`/admin/discover`), 다이닝코드 일괄 저장 (`/admin/diningcode`), **AI 자동 발견** (`/admin/auto-discover`). 결과물은 공개 페이지에서 비로그인 사용자가 그대로 본다. 2026-09 부터 상세 메뉴 탭에 음식 카탈로그 기반 **칼로리 칩**이 붙는다 — 메뉴명 3등급 판정 → LLM 매칭 → 웹 실측 → 세트 분해의 판정 엔진, 골든셋 정밀도 게이트 99.5%([food](food.md), [docs/menu-calorie-engine.md](../../docs/menu-calorie-engine.md)). 2026-09-12 부터 상세 헤더에 **상가 업종 배지·폐업 의심 배지**(`RestaurantStoreMatch` — 소상공인 상가정보와 80m·상호 0.5 매칭, 플래그만 붙이고 목록엔 유지), 2026-09-13 부터 여행로그 장소와 매칭된 가게에 **"여행자" 탭·배지**(`RestaurantTourMatch` — 방문 여행자 수·보정 만족도·1인 지출 중앙값·재방문율, 매칭 없으면 `tour: null`)와 목록 정렬 `tourTravelers|tourScore`, 골라줘 전략 `traveler`(`balanced` 는 리뷰 AI 두 점수와 여행자 점수 중 있는 것의 평균)가 붙는다([tour](tour.md), [canonical](canonical.md)). 2026-09-25 부터 상세 **'가는 법' 탭에 주차 섹션**(분석된 리뷰의 '주차' 관점 긍·부정·중립 건수와 팁, 다이닝코드 시설 정보, 반경 300m 주차장 — 공개 `restaurants/public/:placeId/parking-reviews`)과 홈 탭 한 줄 요약이 붙고([parking](parking.md)), 같은 날 네이버 플레이스 메뉴 구조 개편(`placeMenus`)으로 비배민 가게 메뉴가 조용히 0건이 되던 것을 바로잡아 **메뉴 0건이면 직전 스냅샷을 지키는 보호선**이 생겼다(`43d7e69`, [crawl](crawl.md)). 2026-09-26 어드민 맛집 상세(`/admin/restaurants/:placeId`)는 공개 상세의 탭을 그대로 빌려 쓰는 구성으로 바뀌고, 리뷰 목록·요약 중지/재개/재분석이 네이버 행 하나가 아니라 **canonical 의 모든 출처**(네이버+다이닝코드+테이블링)를 대상으로 한다(`420a6be` — 예: 특돼지 목동점 리뷰 38 → 546, [canonical](canonical.md)).
...
- **생활정보(2026-08-21~)** — 네 공개 페이지(27차에 바다·주차가 더해져 **여섯**)가 같은 정책(비로그인·friendly 프록시 또는 로컬 적재·캐시 보호)으로 나란히 섰다. **집값 `/housing`**([housing](housing.md), 2026-08-30~) — 한국부동산원 아파트 단지 마스터 45,920단지 + 국토교통부 실거래가(RTMS 매매·전월세, 시군구×계약년월 단위로 받아 `HousingTradeSync` 장부가 "어느 달을 받았나" 기억) + 공시가격 zip·K-apt·건축물대장 보강을 **로컬 DB 에 적재**해, 지도 뷰포트(bbox+줌)로 서버 집계 셀(평당가)/단지 가격 배지, 단지 검색·상세·거래 목록(`dealType`·전용면적 `band` 축 공통). 거래는 `HOUSING_REFRESH_CRON` 으로 최근 N개월을 재수집(신고 지연·해제 반영), 단지 좌표는 일상지도와 **같은 지오코딩 캐시 압축본**을 쓴다. **대기질 `/air`**([air-quality](air-quality.md)) — 에어코리아 시도별 실시간·측정소 지도/주변/검색·예보(측정 10분·예보 20분·주간 60분·측정소 24시간 캐시), 로그인 시 '내 대기 위치' 저장(`AirUserLocation`). **날씨 `/weather`**([weather](weather.md)) — 기상청 초단기실황/단기·중기예보 + 광역시 구·군 지점(`weatherRegions`), 발표 시각 단위 캐시, API허브 AWS 매분 관측으로 현재값 보강. **일상지도 `/life-map`**([life-map](life-map.md)) — 전국 CCTV 377,243·공중화장실 53,559·병의원(심평원 API 전량 ~80콜) + 2026-09-12 부터 **생활편의**(소상공인 상가정보 `LifeStore` 약 130만 행 — 편의점·마트·약국·세탁·동물병원·미용실 6종 칩, 카페·음식점·학원은 매칭·인프라 전용) 네 점 레이어를 **로컬 DB 에 적재**해 요청 경로 외부 호출 0, 셀 격자 10분 LRU 캐시, 지역 이동 검색(행정구역·역·정류장·주소). 그 위에 **배경(면) 레이어** 유형이 신설됐다(한 번에 하나, 기본 꺼짐, 레이어 바 구분선 뒤 토글) — **범죄 통계**(경찰청 3074462 시군구 229곳 인구 10만 명당 강력/절도/폭력 5등급, DB 없이 커밋된 정적 JSON `life-crime-stats.json`, 시군구 경계 `sigungu-geo.json` 재사용)와 **여행자 밀도**(여행로그 0.02° 격자 청록 5등급, 칸 클릭 → 방문·여행자 수 + 그 칸의 등록 맛집, [tour](tour.md)). 집값 단지 상세엔 같은 상가 데이터로 반경 500m 생활 인프라(편의점·마트·카페·음식점·학원·병의원·약국 개수, LRU 10분)가 붙는다. 상단바의 "내 위치" 칩이 날씨·대기 두 도메인을 한 알약으로 묶어 10분마다 조용히 갱신한다. 2026-09-24 부터 집값 단지 상세·지도 배지엔 **침수 흔적**(서울시 침수흔적도 43,112 필지의 무게중심 점 — 단지 반경 100m 건수·최대 침수심·사건 연월별 내역, 1~4건 흰 물방울 / 5건↑ 파란 물방울, 서울 밖은 `null`, 주소·필지 비노출)이 붙는다([housing](housing.md)). **바다 `/sea`**(2026-09-24, [sea](sea.md)) — 국립해양조사원 생활해양예보지수 6종(해수욕·서핑·바다낚시·갯벌체험·바닷길·바다여행)을 활동 탭 × 7일 × 오전/오후 슬롯으로 골라 지도 마커색·순위 목록이 바뀌고, 지점 상세는 7일 지수 띠·어종/등급별 지수·이안류(6~9월)·가장 가까운 조석 예보지점의 만조/간조(상태는 URL `?a&d&p&sel`). 적재 없는 순수 프록시(활동별 1시간·물때 12시간 캐시 + 12시간 stale). **주차 `/parking`**(2026-09-25, [parking](parking.md)) — 탭 주차장(표준데이터 + 서울 공영 약 1.8만 곳 로컬 적재, 요금·운영시간·1~3시간 예상 요금, 서울 시영은 실시간 여석 + 요일×시간 평소 혼잡도) | 충전소(환경공단 약 10만 곳·51만 기, 10분 상태 폴러) | 공항(한국공항공사 13곳 + 인천, 5분 폴러). 요청 경로는 로컬 DB + 폴러 메모리라 업스트림 0콜, 혼잡 이력은 "지금부터 축적"(표본이 쌓이면 자동 표시), 체류 시간별 요금 정렬은 하지 않기로 했다([docs/PLAN-parking.md](../../docs/PLAN-parking.md) 결정 표).
...
- **운세·선택 놀이(2026-09-02~, 로그인 없이 무료)** — **타로 `/tarot`**([tarot](tarot.md)): 78장 덱(메이저 22 + 마이너 56, 장면형), 스프레드 5종(오늘의 카드 `daily`·과거현재미래·상황조언결과·A/B 선택 `choice`·**메뉴 타로 `menu`** — 카드 원소·무드로 메뉴 100종 중 후보 3개를 코드가 결정적으로 고르고 LLM 은 이유만), 부채꼴 3D 무대에서 직접 뽑기 또는 자동 뽑기, 해석은 Ollama Cloud(purpose `tarot`, 기본 `gpt-oss:120b`) + 정적 폴백, 공유 토큰·OG·satori 이미지(og/story), 회원은 자동 저장 `/me/tarot` + 오늘의 카드 계정 잠금. **사주(C) `/saju-c`**([saju-c](saju-c.md)): 생년월일시·성별(양/음력·윤달·시 모름) → `@repo/utils` 엔진이 사주팔자·십신·신살·대운·격국·삼재·월운을 **결정적으로 계산**하고 LLM(purpose `saju`, 기본 `kimi-k3`)은 섹션 4개(성격·올해·흐름·조언)를 **병렬 job + long-poll** 로 문장화(캐시 히트면 즉시, 없으면 정적 본문 먼저), 오늘의 운세(회원 하루 1회 잠금)·궁합·택일·오행 음식, 회원 프로필 최대 10명·기록 `/me/saju-c`, 공유는 타로와 같은 패턴. 2026-09-12 8·9차(`739705e`·`baecb9b`)로 **테마 3종**(인연·재물·직업 — 3개 병렬 job, 풀이 탭이 그룹 3×서브 "원국·흐름·테마" 로 재편)·**궁합 입구 모드**("내 사주 / 우리 궁합")·**"사주에 묻기"**(만약에 이랬다면 — 이직·창업·이사·결혼/연애·시험·투자·여행·계약·고백 9주제 × 시점 4종을 코드가 채점·판정하고 LLM 은 답만, 건강·법률·사행성은 정적 차단, "타로로도 보기" `?q=&topic=`, 회원 기록 kind `question`)가 더해지고, 어드민 AI 키 화면에서 사주(C) 행에 kimi 모델 전용 **추론(thinking) 5단계**(끔/낮음/보통/높음/최대 = Ollama think)를 골라 줄 수 있다(`a823af1`, 기본 끔 — maxTokens·타임아웃을 배수로 키움). **사주(G) `/saju-g`**([saju-g](saju-g.md)): 같은 주제의 **별도 구현**(다른 세션, `modules/saju-g`) — 명식 먼저·AI(purpose `saju-g`, `kimi-k3`) 뒤에, 출생 프로필·두 사람 궁합 `/saju-g/pair`·이야기 카드·명시적 보관 `/me/saju-g`·공개 상징만 공유(`/saju-g/s/:token`, 10자 토큰). 셋 다 게스트는 [공용 익명 사용량 한도](../concepts/anonymous-usage-quota.md)([usage-quota](usage-quota.md) — 게스트 키·IP·전역 일일 + IP 분당) 안에서, 회원은 기기·IP 일일 한도 면제. 앱은 3D 를 포팅하지 않고 **WebView 임베드**로 연다([embedded-webview-bridge](../concepts/embedded-webview-bridge.md)).
- **여행로그(2026-09-13~, 공개는 집계·원본은 관리자)** — AI 허브 「국내 여행로그 데이터」 2023(권역당 패널 2,880명이 여행 직후 입력한 방문지·만족도·체류·지출·활동·동선) 4권역(제주·도서 71780 / 서부권 71779 / 동부권 71778 / 수도권 71581)을 리포 밖 변환기(`niney-tour-pickr/tour-c*`, Python/DuckDB — 원본 203/102/93/97GB)가 파생표 10개로 내보낸 것을 `Tour*` 표에 **데이터셋 단위**로 적재해 세 층으로 쓴다([tour](tour.md), [docs/PLAN-tour-log.md](../../docs/PLAN-tour-log.md)). ① **공개 집계**(인증 없음, 응답에 식별자 없음 + 소셀 억제 여행자 5명 미만·평점 3건 미만 숨김): `/travel/jeju` 인사이트(규모·박수·월·동반·시간대×유형·유형별 만족/체류/지출·전이 행렬·코스 템플릿·읍면동·이유·지출 구성·이동수단·거점(역·터미널·공항) 다음 첫 목적지·거주지 — 필터 = URL 쿼리, 지역 21키: 제주·서부권+7시도·동부권+6시도·수도권+3시도·전체), `/travel/plan` 코스 추천(조건 완화 사다리 month→gender→nights→ageGrp → 등록 맛집 체크 → 그룹투표 프리필), 맛집 상세 "여행자" 탭·목록 정렬·골라줘, 일상지도 "여행자 밀도" 배경·지역 비교·숙소 통계. ② **관리자 시드 콘솔** `/admin/tour` — 여행자가 많이 간 미등록 식당을 네이버 검색으로 찾아 기존 크롤 잡으로 등록(등록 후 매칭 자동 재실행), 국세청 사업자 상태로 폐업 확인, 데이터셋별 적재 상태. ③ **원본 열람** — 개별 방문·주문 원문·영수증·참고 사진·여행 타임라인은 AI 허브에서 승인받은 **본인 계정 allowlist(`TOUR_RAW_USER_IDS`)** 만, 밖이면 404·응답 `no-store`·`noindex`. 이용조건상 원본 재배포·국외 반출 금지·출처 표기 필수라 서버는 국내, 공개 화면은 **AI 허브 서면 회신 전 운영 노출 금지**(코드에 노출 스위치가 없어 운영에 export 를 적재하면 공개 집계도 곧바로 켜진다 — Gotchas). 수도권은 거주자 85% 의 근교 나들이 표본(당일 67%)이라 장소당 표본이 얇아 공개 통계 대부분이 억제되고 운영 맛집 매칭(서울 1,810곳)·서울 밀도·나들이 코스 용도. 앱은 미연동(4권역 완성 후 유일한 후속 후보).

세 개의 클라이언트(27차부터 + 외부 프로젝트)가 동일 백엔드를 공유한다:
- **friendly** — Fastify + Prisma + SQLite 백엔드 ([friendly](friendly.md))
- **웹** (`apps/web`) — Vite + React 19 SPA. 공개 영역(`/`, `/restaurants(-v2)`, `/r/:placeId`, `/bus`, `/subway`, `/parking`(27차), `/air`, `/weather`, `/sea`(27차), `/life-map`, `/housing`, `/travel/jeju`, `/travel/plan`(26차), `/tarot`, `/tarot/s/:token`, `/saju-c`, `/saju-c/s/:token`, `/saju-g`, `/saju-g/pair`, `/saju-g/s/:token`, `/s/:token`, `/vote/:token`) + 인증 사용자 영역(`/me/meals`, `/me/settlements`, `/me/contacts`, `/me/tarot(/:id)`, `/me/saju-c(/:id)`, `/me/saju-g(/:id)`, `/me/saju-g/profiles`, `/vote/new`, `/restaurants/:placeId/settle/*`) + 어드민 콘솔(`/admin/*`) 세 묶음이 한 SPA 안에 공존. 공개 메뉴 순서(`PublicSidebar.NAV` = `PublicTopBar.NAV` 두 벌, 26차 11개 → **27차 13개 + 로그인 시 식단 = 14**): 홈 · 맛집 · 대중교통 · **주차**(`/parking`, 27차) · 일상지도 · 집값 · **여행**(`/travel/jeju`, `match: ['/travel']`) · 날씨 · **바다**(`/sea`, 27차) · 대기질 · 타로 · 사주(C) · 사주(G) · 식단(로그인 시만). 어드민 사이드바엔 "여행로그 시드"(`/admin/tour`). 어드민 맛집 상세(`/admin/restaurants/:placeId`)는 27차부터 공개 상세 탭(`?tab=` 홈·분석·여행자·메뉴·리뷰·질문·사진·정보·로그)을 재사용한다. `?embed=1`(또는 앱 브리지 주입)이면 `PublicLayout` 이 상단바·사이드바 없이 본문만 그린다 — 앱 WebView 용
- **앱** (`apps/mobile`) — Expo SDK 54 + React Native 0.81 + React 19. 탭 4개(홈·맛집·대중교통·프로필) + 스택 화면으로 맛집 상세/정산/단골/공유(`s/[token]`)/날씨/대기/일상지도/식단(`meal/{index,new,[id]}`) 풀구현. 타로·사주(C)는 네이티브 화면 대신 **WebView 임베드**(`app/tarot`·`app/saju-c` 가 웹 `/tarot?embed=1`·`/saju-c?embed=1` 을 열고 토큰·게스트 키를 주입) — 홈 `TarotEntryCard`·`SajuEntryCard` 로 진입. 사주(G)·집값·**여행로그**는 앱 미연동(여행로그는 4권역 완성 후 유일한 후속 후보 — 공개 API 는 앱이 같은 계약으로 붙일 수 있게 둠). 26차 앱 변경은 일상지도 생활편의(`store`) 표시와 홈 `SajuEntryCard` 의 "사주에 묻기" 버튼뿐. **27차 앱 변경은 0** — 바다·주차는 앱 미구현(웹 먼저 — PLAN-parking "앱은 다음 단계", 바다 커밋 본문 "앱은 미구현"), 침수 흔적은 집값 자체가 앱 미연동이라 해당 없음. 어드민 UI 는 의도적 미포함. 로컬 빌드는 무료 Apple 팀(Universal Links·Push capability 제거), EAS/유료 팀은 `EXPO_PUBLIC_ENABLE_APPLINKS=1`
- **외부 프로젝트(27차, 2026-09-24~)** — 사용자의 다른 프로젝트가 브라우저에서 이 API 를 직접 부른다: 어드민 외 모든 경로 `Access-Control-Allow-Origin: *`·credentials 없음·레이트리밋 헤더 노출, 인증은 같은 `Authorization: Bearer`(로그인 토큰은 origin 별 localStorage 라 공유되지 않아 따로 로그인). 계약은 zod 가 아니라 **`docs/api/openapi.json`**(`npx openapi-typescript` 로 타입 생성) + 색인 `endpoints.md` + 수기 규칙 `README.md`(기준 URL `https://ninelife.kr`·에러 본문·한도·도메인 개요·데이터 이용 조건) — [api-docs](api-docs.md), [docs/api/README.md](../../docs/api/README.md). LLM·공공 API 비용은 이 서버가 부담하므로 "트래픽을 보고 `CORS_ORIGIN` 목록으로 다시 좁힌다"가 전제
...
## Architecture [coverage: high — 58 sources]

pnpm workspaces + Turborepo 기반 모노레포. (트리의 `(신규)` 는 24차 2026-08-17~08-30 라운드 표기, 25차 2026-08-30~09-07 추가분은 `(25차)`, 26차 2026-09-12~09-19 추가분은 `(26차)`, 이번 27차 2026-09-24~09-26 추가분은 `(27차)`)
...
│   ├── flood/seoul-flood-YYYY.zip   서울시 침수흔적도(OA-15636) 연도별 SHP zip 14개(2010~2025, 2015·2021 없음, 합 ~6MB, UTM-K·DBF CP949) — **`load:life-flood` 가 폴더가 비면 서울 열린데이터 폼 POST 로 자동 다운로드**(로그인·키 불필요), 새 연도 `--download` / 수정본 재수신 `--refresh` (27차)
...
│   ├── tour/{lp-2023,lp-west-2023,lp-east-2023,lp-capital-2023}/   AI 허브 여행로그 export(71780·71779·71778·71581) — manifest.json(exportVersion 1, sha256) + *.jsonl.gz 10표(JSONL 8~17MB) + thumbs/s/*.webp(256px, 172~186MB) ≈ 세트당 190MB. tour-c 가 만들고 rsync 로 운영 반입, 재취득 어려워 **백업 대상**, 재배포·국외 반출 금지 (26차)
│   ├── crime/             경찰청_범죄 발생 지역별 통계_YYYYMMDD.csv(3074462, 29KB, 최신 날짜 자동) + population-YYYYMM.csv(행안부 주민등록 — 없으면 build:life-crime 이 자동 다운로드) → 산출 JSON 은 리포 커밋, DB 없음 (26차)
│   ├── store/store-YYYYMM.zip   소상공인 상가(상권)정보 분기 zip(15083033, 353MB — 시도별 CSV 16개 ~250만 행, 항목명 CP949) — zip 그대로 스트리밍 적재, 최신 파일 glob 자동 (26차)
...
│   │   ├── scripts/             93개 파일·107 스크립트 — load:*(적재) / status:*(한 줄 상태) / probe:*(실응답) / build:*(자산·표·범죄 JSON) / measure:*(골든셋) / backfill:* / eval:* / match:*·check:*·unload:*·e2e:*(26차 신설) / export:openapi(27차) (25차 +25, 26차 +9, 27차 +6)
│   │   │   ├── load-life-flood.ts([dir] --download·--refresh·--dry-run) · load-parking-lots.ts(--sources=std,seoul·--std-json·--offline·--max-calls) · load-ev-chargers.ts(--zcode·--max-pages·--dry-run) · parking-status.ts · export-openapi.ts(docs/api 생성 — app.ready() 만, listen 없음) · backfill-naver-menus.ts(--dry-run·--all·--place·--limit·--delay) (27차 6)
...
│   │   │   ├── load-tour.ts(--dataset·--dry-run) · unload-tour.ts(--yes [--dataset]) · match-restaurant-tour.ts · check-tour-biz.ts(국세청) · e2e-tour.ts(실서버 playwright 32 step) (26차 여행로그 5)
│   │   │   ├── build-life-crime.ts(범죄 CSV × 인구 CSV → JSON 커밋) · load-life-stores.ts(zip 스트리밍) · match-restaurant-stores.ts · probe-store-csv.ts(zip 항목 CP949 프로브) (26차 일상지도 4)
...
│   │   └── src/
│   │       ├── plugins/cors.ts                        ~~dev 전면 origin 반사 허용 (비-LAN 만 warn)~~ → 27차 `1b621c4`: 요청마다 `isAdminPath`(쿼리 제거·퍼센트 디코딩 후 `/api/v1/admin` 판정)로 정책 분기 — 어드민 외 `origin '*'`(prod 는 `CORS_ORIGIN` 목록으로 좁힐 수 있음) · 어드민 prod `PUBLIC_ORIGIN` 만 / dev 반사 · 둘 다 `credentials: false`·레이트리밋 헤더 노출·preflight 600초
│   │       ├── plugins/swagger.ts                     스펙 생성기 전 환경 등록(HTTP 미노출) · `/docs` UI 는 dev 만 · transform 이 라우트 훅·config 에서 `x-auth`(public/optional/user/admin)·`x-rate-limit`·bearer security 부착 · `OPTIONAL_BEARER` export (27차)
│   │       ├── plugins/error-handler.ts               4xx 본문 `{statusCode, error, message}` — 레이트리밋 평객체는 name 대신 객체의 `error` 문자열 (27차 `678ecc0`)
...
│   │       ├── config/env.ts                          DATA_GO_KR_API_KEY **하나**(BUS/AIRKOREA/KMA/HIRA/FOOD_API_KEY 폐기) · KMA_APIHUB · OLLAMA_{TAROT,SAJU,SAJU_G,MENU_MATCH}_MODEL · HOUSING_REFRESH_{CRON,MONTHS} · FOOD_RECIPE/MAFRA · MEAL_* (25차) · TOUR_RAW_USER_IDS(원본 allowlist, 기본 '') · TOUR_THUMBS_DIR(_WEST|_EAST|_CAPITAL)(비우면 export 폴더의 thumbs) (26차) · PARKING_LIVE_CRON(기본 `*/5 * * * *`)·EV_STATUS_CRON(기본 `*/10 * * * *`, 빈 값 = 끔) · CORS_ORIGIN 주석(어드민 외·prod 만) · data.go.kr 주석에 바다 8·주차 4 데이터셋 (27차)
...
│   │       ├── test-utils/temp-db.ts                  useIsolatedDatabase() — DB 건드리는 테스트 필수 격리 (~~17파일~~ → 27차 **28파일**: +parking.test·summary.test). dev.db(3.6GB)를 통째 복사해 비우므로 `vitest.config.ts` `hookTimeout` 60초 (27차 `5d7b686`)
│   │       ├── app.{cors,openapi,errors}.test.ts      앱 연결 테스트 — `src/plugins/*.test.ts` 는 autoload·tsup 이 플러그인으로 로드하므로 src/ 루트에 (CLAUDE.md 6번, 27차)
│   │       ├── test-utils/schema-db.ts                useSchemaDatabase() — 현재 schema.prisma 로 빈 임시 DB(prisma db push), 실데이터 복사 없음 (7파일, 25차 — 사주(G) 세션)
│   │       └── modules/                               42 모듈 (27차 +sea·parking — 비-어드민 route 32파일에 한국어 `summary` 일괄)
│   │           ├── parking/                           주차(27차, 12 파일 — 테스트 4) — parking-api.adapter(data.go.kr·서울 열린데이터 봉투) · parking-master(표준 camelCase·포털 UPPER_SNAKE 통일, 서울 노상 구획 접기, 표준↔서울 겹침 접기) · parking-live(5분 폴러·혼잡 이력 UPSERT) · parking.service(점/셀·주변·상세·예상 요금) · ev-master·ev-status(10분 폴러, `UPDATE … FROM`)·ev.service · parking.route(폴러는 **onListen** 에서만 start, 맛집 리뷰 '주차' 집계 라우트 포함) → [parking](parking.md)
│   │           ├── sea/                               바다(27차, 4 파일) — khoa.adapter(`response` 감싸개 없는 봉투·페이지 순회·재시도) · sea.service(활동별 1시간·물때 지점×날짜 12시간 캐시 + 12시간 stale, 어종·등급 행 → 슬롯 variants 로 440→196KB) · sea.route · sea.test — **적재·DB 없음** → [sea](sea.md)
│   │           ├── tour/                              여행로그(26차, 20 파일 — 테스트 8) — tour-master(정규화·데이터셋 단위 교체·plausibility·sido 파생열·sync) · restaurant-tour-match(canonical 1:1) · tour-biz-status(국세청 15081808) · tour-admin(시드 콘솔 route/service) · tour-raw(allowlist 원본 route/service) · tour-public(상세 집계 + 공개 route) · tour-insights(인사이트·코스, LRU 10분) · tour-region(밀도·숙소·지역비교) · tour-region-filter(region 21키 → 표별 where 한 곳)
...
│   │           ├── housing/                           집값 — rtms/kapt/bldg-hub/datago-json 어댑터, 단지·거래·공시가격·K-apt·건축물 마스터, 파생 통계, 지오코딩, 월 갱신 croner(housing-refresh) (25차) + housing-flood(침수 흔적 메모리 격자 색인, 반경 100m, 27차)
│   │           ├── air-quality/ · weather/            에어코리아·기상청 프록시 (+__fixtures__ 실응답, 신규)
│   │           ├── life-map/                          CCTV·화장실·병의원·**상가(생활편의)** 로컬 적재 + 셀 캐시 + 지역 검색 + **범죄 통계 배경** (신규, 26차 확장)
...
│   │           │   ├── life-crime.service.ts · life-crime-build.ts · data/life-crime-stats.json   범죄 통계 — 빌드 산출 JSON 66KB 커밋(DB 없음), 기동 시 계약 검증, GET /life-map/crime (26차)
│   │           │   ├── life-store-master.service.ts                  상가 zip 항목별 deflate 스트리밍 적재(관심 업종 9종, 1,307,626행, 149초) (26차)
│   │           │   └── life-flood-master.service.ts(+test)           서울 침수흔적도 SHP/DBF 파서(DBF CP949·2022 UTF-8 혼재·연도별 스키마, zip 리더는 housing-price-master 재사용) → 필지 무게중심 `LifeFloodTrace` 43,112점 + `LifeMasterSync layer=flood` — 일상지도 화면 레이어는 없고 집값이 소비 (27차)
│   │           ├── restaurant/restaurant-store-match.service.ts   맛집 canonical ↔ 상가업소 1:1 매칭(80m·상호 0.5, RestaurantStoreMatch — 재실행 멱등) — 여행로그 매칭과 같은 골격 (26차)
...
│   │       ├── components/{tarot,saju,saju-g,housing}/   11·11·12·6 파일 — tarot/saju 는 stage/(R3F 무대) + *Lite + *ReadingView(2D 공용) + *ShareSheet (25차) — saju/ 는 26차 15 파일(+SajuAsk·SajuThemes·SajuPairPanel·sajuPanelTabs: 묻기·테마 3종·궁합 입구·탭 그룹 3×서브)
│   │       ├── components/tour/                      7 파일 — TourFilterBar(2행 지역 칩 권역 → 시도 + 테스트)·charts·tourFormat·TourRegionSection·TourLodgingSection·TourSourceNote(출처 문구) (26차)
│   │       ├── components/admin/tour/TourEvidencePanel.tsx   여행자 근거 카드(방문·주문 원문·영수증·사진·여행 타임라인 — 원본 allowlist 만 렌더) (26차)
│   │       ├── components/restaurant/detail/{TourTab,TourSummaryBadge,TourMatchBadge,StoreInfoBadges}.tsx · tabs.ts   여행자 탭(매칭 있을 때만)·배지 / 상가 업종·폐업 의심 배지 (26차)
│   │       ├── components/life-map/{LifeCrimeCard,LifeTourCard}.tsx · lifeMapAreas.ts · lib/{tourDensityGeo,useSigunguGeo}.ts   배경(면) 레이어 2종 카드·OL 면 스타일·격자 피처·시군구 경계 (26차)
│   │       ├── routes/{TravelInsightsPage,TravelPlanPage}.tsx · routes/admin/AdminTourPage.tsx   /travel/jeju · /travel/plan · /admin/tour (26차, lazy)
│   │       ├── routes/SeaPage.tsx(+test) · components/sea/{SeaMap,SeaSpotDetail,seaFormat}   /sea — 지도 + 순위 목록 **그리드**(시트 아님, 모바일은 지도 360px 아래 목록), 상태 URL `?a&d&p&sel` (27차, lazy)
│   │       ├── routes/ParkingPage.tsx(+test) · components/parking/{ParkingMapView,ParkingTabBar,ParkingLists,ParkingDetails,ParkingFooter,parkingFormat,parkingMarkers} · stores/parkingPrefsStore.ts   /parking — 지도 + 시트(`useMapSheets`·`useIsDesktopXl`, 집값·일상지도와 같은 골격), 탭 `?t=`·위치 `?ll&z`·선택 `?sel` 은 URL, 필터는 localStorage `lp:parking-prefs` (27차, lazy)
│   │       ├── components/restaurant/detail/ParkingSection.tsx(+test) · TransitTab · HomeTab(`ParkingSummaryLine`)   맛집 상세 '가는 법' 주차 섹션 + 홈 한 줄 요약 (27차)
│   │       ├── components/admin/restaurant-detail/{AdminDetailHeader,AdminLocationAside,AdminRawInfo,AdminReviewItem,AdminReviewsTab,tabs} · routes/admin/AdminRestaurantDetailPage.tsx(+test)   어드민 맛집 상세 — 공개 상세 탭 재사용 + 출처 통합 리뷰 탭 + 헤더 출처 행 (27차 `420a6be`)
...
│   │       ├── components/PublicTopBar.tsx · PublicSidebar.tsx · AccountMenu.tsx   폭 예산(<md/md~lg/lg+/xl+) + 드로어 하단 계정·테마 (신규) — NAV 10개 + 계정 메뉴 "내 타로 기록" (25차) → NAV 11개("여행", 26차) → NAV 13개 + 로그인 시 식단(**주차**·**바다**, 27차 — 두 파일에 NAV 배열이 각각 있어 둘 다 고쳐야 한다)
...
│   │       ├── stores/lifeMap{Prefs,Recent}Store.ts  localStorage 'lp:life-map-prefs' / 'lp:life-map-recent' (신규) — prefs v5 `overlay`(crime|tour|null)·`tourDensityKind` (26차)
...
│   │   │   ├── air/ · weather/ · life-map/         생활정보 화면 (홈 MyLocationCard 에서 진입, 신규) — life-map 은 26차 생활편의(store) 표시(LifeDetailPanel·LifeNearbyRows·lifeMapPrefsStore 갱신), 배경 레이어·여행로그 화면은 앱 미구현. 바다·주차 화면도 없음(27차 앱 변경 0)
...
│   │   ├── src/components/home/{TarotEntryCard,SajuEntryCard}.tsx   홈 진입 카드(타로 보기·메뉴 타로 / 사주 보기·오늘의 운세·"사주에 묻기" ?tool=ask) (25차, 26차 버튼 추가)
│   │   └── src/components/settlement/              SettlementWizard / Step1~4 / *Sheet / *Editor
├── packages/
│   ├── api-contract/      Zod SSOT → api-contract 토픽 — schemas/ 46개 (+sea·parking(377줄) 27차 — housing `flood`·restaurant `AdminVisitorReview`·`RestaurantDetail.canonicalId/sources` 도 27차, routes.ts `Routes.Sea/Parking/Restaurant.reviewMatch`; zod → fastify-type-provider-zod → swagger → `docs/api/openapi.json` 로 외부 문서화) (+tour 26차 — TOUR_DATASET_KEYS 4·TOUR_REGION_KEYS 21 리터럴은 utils 와 이중 정의; +tarot/saju/saju-g/housing/usage-quota/menu-lexicon/menu-nutrition 25차) + routes.ts `Routes.Tour(admin*·adminPlace*·public*)/Tarot/Saju(/saju-c, +themes·ask)/SajuG/Housing/UsageQuota/LifeMap.crime`
│   │   └── eslint.config.mjs    @repo/config/eslint/base 직결
│   ├── shared/            FE 공통 (API 46 / hooks 50 / stores 30 — +sea.api·useSea·parking.api·useParking, useRestaurant 에 useRestaurantCanonicalSummaryEvents·useRestaurantReviewMatch·useInvalidateRestaurantDetailCaches, summarySseManager prev·replay 를 restaurantId 단위로 27차; +tour.api·useTour(공개 집계·어드민·원본 useTourRaw*·tourPhotoUrl) 26차) → shared 토픽 (+tarot·saju·saju-g·housing·usage-quota api/hooks, guestKeyStore·tarotHistoryStore·sajuProfileStore·sajuG{History,Profile}Store·sajuGStorageMigration, **embedBridge.ts** 브리지 계약, 25차)
│   ├── utils/             순수 유틸 59 파일(테스트 34) → utils 토픽 (+lifeFlood·parking·parkingMarker·sea·seaStations(조석 166·이안류 10 좌표표), geo.ts `utmkToWgs84`/`wgs84ToUtmk`(EPSG:5179, 데이텀 변환 없음), housingMarker 물방울 글리프, 27차) (+tourLog(TOUR_DATASETS·TOUR_REGIONS 21키·권역 묶음·표본 판정·격자·등급·출처 문구)·lifeCrime·lifeStore·sajuThemes·sajuAsk, aiModel thinking, 26차) (+tarot·tarotCards·tarotFlow·tarotMenu / saju·sajuCalendar·sajuAstroTable(생성물)·sajuText·sajuDaily·sajuMatch·sajuDatePick·sajuFood·sajuFlow·sajuImages·sajuInsights·sajuDayPillar / saju-g·saju-g-stories / housing·housingMarker, aiModel purpose 확장, 25차)
│   └── config/            tsconfig + ESLint 베이스 → config 토픽
│       └── eslint/{base,node,react}.js   base(TS) ← node(+Node 글로벌) / react(+react-hooks v7)
├── deploy.sh              운영 서버 배포 스크립트 — 케이스 1~9 (6·7·8·9 = 데이터 적재 전용) + 1·2·4 에서 일상지도·음식 카탈로그·**집값**·**주차** 자동 점검 (27차: `life_map_data` 에 침수 흔적 — `flood=0`(또는 force) 이면 `load:life-flood`(force 는 `--download`) · 새 함수 `parking_data`(`status:parking` 의 `lots`·`ev` 가 0 이면 `load:parking-lots`·`load:ev-chargers`, 실패는 안내 후 계속) 를 케이스 1·2·4 체인 끝에 · **케이스 9** = 주차 데이터 적재/갱신 `pull → gen → parking_data 1`) (25차: housing_data + 케이스 8 + K-apt 탐지 set -e 함정 수정) (26차: `life_map_data` 에 상가 zip 적재·매칭 + 여행로그 "키|폴더|이름" 세트 루프 — `tour_<세트>=0` 만 적재 → `match:restaurant-tour` 1회, 상가 zip 탐지 glob 루프 `127e746`)
├── docs/
│   ├── api/               **외부 API 문서** (27차 `1b621c4`) — README.md(수기 243줄: 기준 URL·CORS·인증 3등급·에러 본문·레이트리밋/일일 한도·도메인 개요·데이터 이용 조건·openapi-typescript·알려진 한계) + endpoints.md(자동 — 태그별 색인, 192개: 공개 83·선택 15·로그인 94) + openapi.json(자동 — OpenAPI 3, 경로 159·operation 192, 53,919줄 — `1b621c4` 첫 생성 51,599줄). `pnpm --filter friendly export:openapi` 로 재생성, 어드민 제외
│   ├── PLAN-parking.md    주차 계획 — 사용자 결정 표(별도 메뉴·3탭·가는 법 섹션·혼잡 이력 축적·요금 정렬 안 함)·원천 7행·호출량·구조·차수 1~5·함정 (27차)
│   ├── PLAN-perf-security.md   보안·성능 감사 9차수 계획·진행 — #42(CORS fail-closed) 아래 **2026-09-24 번복** 문단(어드민 외 `*`+credentials false, 남는 위험 = 비용) (27차 기록)
│   ├── data-sources.md    원본 데이터 운영 가이드 — 보관표·적재 명령·평가셋 추출 코드·백업 대상·테스트 격리 경고 (+집값 5행·원재료 DB·큐레이션·fatsecret 실측, 25차) (+tour 4행(백업 대상)·crime 2행·store 행·범죄 JSON 빌드 절, 26차) (+flood 행(OA-15636, 자동 다운로드)·바다 "API 만" 문단, 27차 — 주차는 표·문단 없음)
│   ├── deploy-friendly.md pm2 + nginx + Cloudflare 운영 가이드 (ninelife.kr) + 음식 카탈로그 적재 + 사용자 업로드 파일 백업 (+타로·사주 nginx 블록 4개·SPA 폴백 충돌 절·사주 글리프, 25차) (+여행로그 원본·사진 절 — rsync 4세트·`--dry-run` sha 대조·세트별 적재·allowlist·썸네일 env·폐업 조회 키·Cloudflare 우회·환수, 26차)
│   ├── PLAN-tour-log.md   여행로그 계획 — 이용조건 판정표·용어·"한 DB 두 출구"·export 계약(JSONL.gz 10표)·DB 모델·로더/운영·공개/관리자 API·웹 화면·보안 체크리스트·단계 0~9차 진행표·부록 A 출처 문구·B AI 허브 문의문·C 결정 이력 (26차)
...
├── .gitignore             /data/(공공데이터 원본 — 주석 목록에 /data/open/flood/ 추가, 27차) · /assets-src/{tarot,saju}/raw/(이미지 원본, 25차) · /ios /android /app.json(루트 expo 오염) · apps/friendly/data/* 무시
├── pnpm-workspace.yaml    apps/* + packages/*
├── turbo.json             dev / build / typecheck / lint / test 파이프라인
├── tsconfig.base.json     루트 TS 베이스 (ES2022, strict, noUncheckedIndexedAccess)
├── CLAUDE.md              에이전트 가이드 (이 위키와 함께 본다) — "용어" 섹션 + iOS 링크 오류 안내 문단 + 핵심 규칙 **6번 외부 API 문서**(비-어드민 라우트 summary·OPTIONAL_BEARER·export:openapi 재생성·plugins/ 에 test 금지, 27차)
...
26차에 세 변형이 더 붙었다. **여행로그**([tour](tour.md))는 원본이 CSV 가 아니라 리포 밖 변환기(`niney-tour-pickr/tour-c*`)의 export(JSONL.gz 10표 + manifest sha256 + 썸네일)이고, 적재 단위가 "전량" 이 아니라 **데이터셋(권역)** — `load:tour <dir> --dataset jeju|west|east|capital` 이 그 세트 행만 지우고 넣는다(코드표만 공용 통째). `status:life-map` 한 줄이 `tour=N tour_jeju=… tour_west=… tour_east=… tour_capital=… tour_matched=X` 를 내고(`TOUR_DATASET_KEYS` 로 자동), `deploy.sh` 는 "키|폴더|이름" 루프로 `tour_<세트>=0` 인 세트만 적재한 뒤 `match:restaurant-tour` 를 한 번 돈다(세트 추가 = 루프 한 항목 + `TOUR_<KEY>_EXPORT_DIR`). 재취득이 어려워(AI 허브 로그인·승인·권역당 93~203GB 원본) export 는 **백업 대상**이고 rsync 로만 반입한다(FTP 로 올렸으면 `--dry-run` 의 sha256 대조가 깨짐을 잡는다). **상가정보**는 zip(353MB)을 풀지 않고 항목별 deflate 스트리밍으로 관심 업종 9종만 적재(`load:life-stores`, 1,307,626행 149초) → 바로 `match:restaurant-stores`. **범죄 통계**는 DB 를 거치지 않는다 — `build:life-crime` 이 경찰청 CSV × 행안부 인구 CSV(로그인·키 없이 `downloadCsv.do` 폼 재현으로 자동 다운로드) × 시군구 경계(`apps/web/public/sigungu-geo.json`, KOSIS 코드)를 이름으로 이어(시도 축약표 + 별칭 2건: 인천 미추홀구 ↔ 옛 `남구`, 군위군은 대구 소속 열만) `modules/life-map/data/life-crime-stats.json`(66KB)을 만들고 **그 JSON 을 커밋**, 서버는 기동 시 계약(`LifeCrimeStatsResult`)으로 검증만 한다 — 새 연도는 CSV 교체 → 재빌드 → 커밋이면 끝(운영 배포 단계 없음). 지오코딩 캐시 압축본과 같은 "가공물만 커밋" 원칙의 확장이다.

27차(2026-09-24~25)에 변형이 셋 더 붙었다 — 이번엔 전부 "사람이 원본을 서버에 올리는 단계"가 없다. **침수 흔적**(`ad48f96`, [life-map](life-map.md)·[housing](housing.md))은 파일 원천이지만 `load:life-flood` 가 `data/open/flood/` 가 비면 서울 열린데이터 데이터셋 페이지의 `downloadFile(seq)` 폼 POST(`datafile.seoul.go.kr/.../nio_download.do`)를 재현해 연도별 zip 14개(~6MB)를 **스스로 받아** 적재한다(수 초, 43,112점 교체). `deploy.sh` `life_map_data` 는 `status:life-map` 의 `flood=0` 이면 자동, 케이스 6(force)이면 `--download` 로 새 연도 목록을 다시 본다. 원본은 여전히 git 밖(`.gitignore` 주석에 `/data/open/flood/`), `docs/data-sources.md` 보관표에 flood 행. **주차**(`2ff2c31`, [parking](parking.md))는 원본 파일이 전혀 없는 API 적재 — 표준데이터 15012896 오픈API 1,000행 × ~19콜 + 서울 공영 `GetParkInfo` 2,189행 → `ParkingLot` 전량 교체, 환경공단 충전기 9,999행 × ~53콜 → `EvStation`·`EvCharger` 전량 교체, 상태 한 줄은 `status:parking`("ok lots=N std=S seoul=U geocoded=G ev=E chargers=C" — `ParkingSync` 최신 행 원천). `deploy.sh` 새 함수 `parking_data` 가 같은 `stat_val` 로 읽어 비었을 때만 첫 적재하고 케이스 **9** 가 강제 재적재다. 다만 서울 구영 주차장은 좌표가 없어 지번 주소를 VWorld 로 지오코딩하는데(일상지도·집값과 **같은 `LifeGeocodeCache`**), 배포 경로가 `--offline` 을 쓰지 않아 첫 적재 때 서버에서 ~700콜이 나간다(deploy.sh 주석) — 일상지도·집값의 "운영 호출 0건" 규약과 다른 점. 표준데이터는 `--std-json=<파일|폴더>` 로 포털 JSON 파일에서도 넣을 수 있다. 실시간 여석·공항·충전기 상태는 적재가 아니라 서버 폴러(5분·10분)가 채운다. **바다**(`4a2bff1`, [sea](sea.md))는 적재 자체가 없다 — 요청 경로 프록시 + 메모리 캐시만이고, 코드표에 없는 지점 좌표(조석 예보지점 166·이안류 해수욕장 10)만 2026-09-24 지점별 1회 호출로 모아 `packages/utils/src/seaStations.ts` 로 커밋했다("가공물만 커밋"의 코드 버전 — 지점이 늘면 다시 모은다). [open-data-master-load](../concepts/open-data-master-load.md) 의 적재 도메인은 이로써 지하철·버스·일상지도·음식·집값·여행로그·**주차** 에 침수 흔적(일상지도 마스터)까지.

### 외부 공개 API — CORS 개방 + `docs/api` 자동 생성 + CLAUDE.md 6번 규칙 (27차)

2026-09-24 사용자 결정("내 다른 프로젝트에서 쓸 것 — 운영도 CORS 다 풀고, 트래픽 보고 나중에 제한. 어드민 제외, 열 수 있는 건 다 열기(LLM 포함)")으로 이 백엔드는 웹·앱 전용에서 **외부 프로젝트도 쓰는 공개 API** 가 됐다(`1b621c4`, 자세한 건 [api-docs](api-docs.md)). 문서의 원천이 따로 있는 게 아니라 이미 있던 zod SSOT([zod-ssot-buildless](../concepts/zod-ssot-buildless.md))를 한 번 더 내보내는 구조다:

```
packages/api-contract/src/schemas/*.ts (zod)            modules/**/*.route.ts  schema.summary(한국어)·description·tags
        │ fastify-type-provider-zod (검증·직렬화)              │ 선택 인증은 security: OPTIONAL_BEARER (plugins/swagger.ts export)
        ▼                                                      ▼
plugins/swagger.ts  @fastify/swagger — 전 환경 등록(HTTP 미노출) · /docs UI 는 isDev 만
   transform: 라우트 훅(requireAuth/requireAdmin/resolveOptionalUser)·config 를 읽어
              x-auth: public | optional | user | admin  ·  x-rate-limit: {max|'dynamic', timeWindow}  ·  security: bearerAuth
        ▼ pnpm --filter friendly export:openapi   (scripts/export-openapi.ts — buildApp → app.ready() → app.swagger() → close, listen 없음)
docs/api/openapi.json  (어드민·HTML 미리보기 제외 — 경로 159 · operation 192)      ─→ 외부: npx openapi-typescript → openapi-fetch
docs/api/endpoints.md  (태그별 색인: 메서드·경로·인증·한도·입력·summary — 공개 83 · 선택 15 · 로그인 94)
docs/api/README.md     (수기 — 기준 URL·CORS·인증·에러 본문·한도·도메인 개요·데이터 이용 조건·알려진 한계)
```

CORS 는 `plugins/cors.ts` 의 `@fastify/cors` `delegator` 가 **요청마다** 정책을 고른다 — `isAdminPath(url)`(쿼리 제거 + `decodeURIComponent` 후 `/^\/api\/v1\/admin(?:\/|$)/`, `/api/v1/%61dmin` 우회 차단)면 어드민 정책(prod `PUBLIC_ORIGIN` 만, dev 반사), 아니면 공개 정책(`origin: '*'`, prod 에서 `CORS_ORIGIN` 이 `*`·빈 값이 아닌 목록이면 그 목록). 두 정책 모두 `credentials: false`(인증이 `Authorization: Bearer` 헤더뿐이라 쿠키 세션 도용 위험이 없고, 나중에 쿠키가 생겨도 타 사이트가 못 쓰게) · `exposedHeaders` `x-ratelimit-limit/remaining/reset`·`retry-after` · preflight `maxAge` 600초(좁혔을 때 10분 안 반영) · 요청 헤더는 반사(`x-guest-key` 포함). 이전 정책(2026-05-31 dev 반사 + RFC1918 밖 origin warn, 2026-06 감사 #42 "prod `*` 면 `PUBLIC_ORIGIN` 으로 fail-closed")은 폐기됐고 번복 사유·남는 위험(비용 — LLM·업스트림 쿼터, IP 분산으로 IP당 레이트리밋이 약해짐)은 [docs/PLAN-perf-security.md](../../docs/PLAN-perf-security.md) #42 아래에 적혔다. 같은 날 `678ecc0` 은 `@fastify/rate-limit` 이 던지는 평객체(`{statusCode, error, message}` — `Error` 아님, `name` 없음) 때문에 전역 에러 핸들러의 429 본문에서 `error` 가 빠지던 것을 고쳤다 — 외부 소비자가 README 의 "에러 본문은 공통 `{statusCode, error, message}`" 를 믿고 분기할 수 있게.

규약은 **CLAUDE.md 핵심 규칙 6번**으로 굳었다: 비-어드민 라우트를 추가·변경하면 ① schema 에 한국어 `summary`(필요하면 `description`), 선택 인증이면 `security: OPTIONAL_BEARER` ② `export:openapi` 로 `openapi.json`·`endpoints.md` 재생성(공통 규칙은 수기 README) ③ `src/plugins/` 에 `*.test.ts` 를 두지 말 것 — `@fastify/autoload` 와 tsup 빌드가 그 폴더의 파일을 전부 플러그인으로 로드하므로 앱 연결 테스트는 `src/app.*.test.ts`(`app.cors.test.ts` 7·`app.openapi.test.ts` 5·`app.errors.test.ts` 2 케이스). 재생성은 **수동**이다 — CI 가 없고(`.github/` 없음) 테스트는 transform 규칙만 검사해, 라우트를 바꾸고 재생성을 잊어도 아무것도 깨지지 않는다(Gotchas). 이 라운드 안에서도 `2ff2c31`(주차)이 재생성했고 `420a6be`(어드민만 변경)는 재생성해도 차이가 없었다.

### 서버 백그라운드 작업의 시작 지점 — `server.ts` · `onReady` · `onListen` (27차 정리)

27차 주차 폴러가 새 시작 지점(`onListen`)을 쓰면서, 한 `buildApp()` 을 여러 프로세스(서버·`app.inject()` 테스트 143파일·`export:openapi`·`probe:meal-e2e`)가 공유할 때 부수효과가 어디까지 번지는지가 정리됐다 — 컨셉 [server-only-boot-effects](../concepts/server-only-boot-effects.md), 세부는 [friendly](friendly.md).

| 지점 | 실행되는 곳 | 무엇 |
|---|---|---|
| `server.ts` — `listen` **전** 순차 bootstrap | 실제 서버 프로세스만 | 리뷰 요약 stale 정리(`cleanupStaleReviewSummaries` → `failed/server_restart`) → 재큐잉(`rescheduleStaleSummaries`, 27차 `summaryChannelKey` 로 키 수정) → `schedule.bootstrap()` → 텔레그램 설정 → 맛집 자동 발굴 → 음식 카탈로그 적재 잡 |
| 플러그인·라우트 `onReady` | `app.ready()` 를 부르는 모든 프로세스(서버·inject 테스트·`export:openapi`) | 집값 월 갱신 croner(`HOUSING_REFRESH_CRON`, 빈 값이면 끔) · 리뷰 군집 기동 리컨실(`setTimeout(...).unref()` 지연 예약) |
| 라우트 `onListen` (**27차 신설**) | 포트를 여는 서버만 | 주차 실시간 폴러(`PARKING_LIVE_CRON`, 기동 직후 1회 + 5분) · 충전기 상태 폴러(`EV_STATUS_CRON`, 10분) — croner `unref`. 테스트(`isTest`)면 cron 을 아예 빈 값으로 |
| `onClose` | 전부 | 폴러·스케줄러 stop, SIGTERM 은 `scheduleRegistry.stopAllCrons()`+`abortInflight()` 후 `app.close()`(15초 안전망) |

### 여행로그 — 한 DB, 두 출구 + 데이터셋 단위 교체 + 공개 노출 게이트 (26차)

AI 허브 이용조건이 구조를 정했다 — 원본(개별 기록·사진·GPS)의 제3자 열람·제공 금지, 집계·서비스 등 2차 저작물은 출처 표기 시 영리 포함 자유, 국외 반출 금지, 부적합 시 환수·폐기 요구 가능. 그래서 운영 DB 하나에 파생표를 두되 출구를 나눈다([docs/PLAN-tour-log.md](../../docs/PLAN-tour-log.md) §구조·§이용조건, 자세한 표·수치는 [tour](tour.md)).

```
niney-tour-pickr/tour-c · tour-c-west · tour-c-east · tour-c-capital   (리포 밖, Python/DuckDB — 원본 203/102/93/97GB)
   prepare.py → 파생 parquet → export_life_pickr.py → lp-{,west-,east-,capital-}2023/  (manifest.json sha256 · *.jsonl.gz 10표 · thumbs/s 256px webp)
   서부·동부·수도권은 tour-c 를 고치지 않고 TOUR_DATA_ROOT + source-view junction(원본 배치를 제주식으로) 으로 재실행 — manifest.dataset 은 늘 71780
        │ rsync (git 밖 data/open/tour/<export>/, 세트당 ≈190MB)
        ▼
   pnpm --filter friendly load:tour <절대경로> --dataset jeju|west|east|capital [--dry-run]     (--filter 는 apps/friendly 기준이라 경로는 절대경로)
        manifest sha256 대조 → 정규화 순수 함수(좌표 한국 범위·비공개 방문 21/22/23 마스킹 재검증·제외 열·필수값, 사유별 drop 리포트)
        → plausibility: 여행 표의 제주 방문 비율(jeju ≥50%, 그 밖 <10%) — manifest 가 세트를 못 알려주므로 --dataset 오지정을 여기서 차단
        → 트랜잭션: 그 세트 행만 삭제·삽입(청크, 바인드 32,766 아래; codes 는 공용 통째 교체), 제주 외 세트는 장소 id 에 "<key>:" 접두, TourSpend.id 자체증가
        → 적재 뒤 SQL 로 sido 파생열(trips.visitSidos ",전북,대전," 꼴 · day_sequences.sidos · transitions.fromSido/toSido) → LifeMasterSync layer=tour|tour-<key>
        ▼
   Tour* 10표(dataset 열 기본 'jeju', FK 없음) + RestaurantTourMatch · TourPlaceBizStatus
     ├─ 공개 출구   tour-public · tour-insights · tour-region service — 집계만. region 21키는 tour-region-filter.ts 한 곳에서 표별 where
     │             소셀 억제 TOUR_K_MIN=5 · 평점 TOUR_RATING_MIN_N=3 · 여행 <20 이면 insufficient · 필터 키 LRU 10분 · RATE.tourRead 120/분
     │             응답 zod 스키마에 travelId/visitAreaId/travelerLabel/photoId 없음 — 테스트가 응답 키를 스캔해 고정
     │             → /tour/public/{insights,plan,density,lodging,regions} · /restaurants/public/:placeId/tour-stats · 목록 sort=tourTravelers|tourScore · smartPick traveler
     ├─ 관리자 출구  tour-admin — /admin/tour/{status,seeds,seeds/:id/discover|register,match/run,biz-status/run}  (authenticate + requireAdmin)
     │             RestaurantTourMatch(canonical 당 1행·tourPlaceId unique·100m/상호 ≥0.5·완전일치 300m·상태 matched|missing) · TourPlaceBizStatus(국세청 15081808, 장소별 최빈 사업자번호, 100건/콜)
     └─ 원본 출구   tour-raw — /admin/tour/places/:id/{visits,activities,spend,photos,trips} · trips/:travelId · photos/:photoId/:size
                   admin + TOUR_RAW_USER_IDS allowlist(user id 또는 이메일, 대소문자 무시) 밖이면 404 · onSend `Cache-Control: private, no-store` + `X-Robots-Tag: noindex`
                   사진은 ?token= 도 인증(토큰에 이메일이 없어 DB 조회 1회), 파일 폴더 TOUR_THUMBS_DIR(_<KEY>) — nginx 정적이 아니라 인증 라우트 스트리밍
   환수·폐기: unload:tour --yes [--dataset]  (Tour* + 매칭 + 상태 삭제 + sync 행 count 0) + rm -rf data/open/tour/<export>
```

지역 축은 7~9차에 걸쳐 `jeju|all` → **21키**(`jeju` · `west`+전북·전남·충남·대전·충북·광주·세종 · `east`+강원·경북·경남·부산·대구·울산 · `capital`+서울·경기·인천 · `all`)로 자랐고, 정의는 utils `TOUR_DATASETS`(aihub·name·label·exportName·idPrefix·sidos)·`TOUR_REGIONS`(label·parent·sidos·center·bbox·hubs·hubLabel)·`TOUR_REGION_GROUPS`(칩 1행 권역 → 2행 시도)·`tourSampleRegionAt/nearestTourSampleRegion`(밀도 레이어를 켤 때 표본 밖이면 가까운 세트 중심으로 이동 — 서울은 9차부터 표본 안) 한 곳이다. 계약 `TOUR_DATASET_KEYS`·`TOUR_REGION_KEYS` 는 utils → api-contract import 가 순환이라 **리터럴을 다시 적고 friendly `tour-master.service.test.ts` 가 동일성을 검증**(foodTaxonomy 규약). 권역 추가는 상수 한 항목 + 계약 두 배열 + `env.ts`/`.env.example` 썸네일 키 + `deploy.sh` 루프 한 항목이면 끝난다는 것이 8·9차(`93ae031`·`6cae6b2`)에서 확인됐다 — 로더·마이그레이션·region-filter·웹 컴포넌트 수정 0.

**공개 노출 게이트.** 이용정책 "인공지능 학습모델의 학습용으로만" 조항과 FAQ "2차 저작물(서비스) 영리·비영리 자유" 안내가 문언상 충돌해, 공개 화면(`/travel/*`·상세 여행자 탭·목록 정렬/골라줘 칩·일상지도 밀도)은 **AI 허브 서면 회신(PLAN 부록 B 문의문 — 4 데이터셋) 뒤에만 운영 노출**한다는 것이 0차부터의 결정이고 7~9차 커밋 본문마다 재확인됐다. 코드엔 노출 스위치가 없다 — 운영에 export 를 적재하면(`deploy.sh` 는 manifest 가 있으면 자동 적재) 공개 집계 라우트도 곧바로 응답하므로(매칭 없는 식당은 `tour: null` 이라 조용), 회신 전엔 운영 반입 자체를 보류하는 것이 실제 게이트다. 출처 표기는 `TOUR_SOURCE_NOTE`(NIA 사업결과·데이터명 4개 자동·aihub.or.kr·"2023년 4~9월 패널 표본, 현재 영업 상태나 관광객 전체를 대표하지 않음")를 집계를 쓰는 모든 섹션 하단(`TourSourceNote`)과 일상지도 푸터에 둔다. 사진 캡션(CC-BY-SA)은 공개 화면에 안 쓴다. 관리자 원본 화면은 Cloudflare 프록시(해외 장비)를 거치지 않는 경로(DNS 전용 서브도메인 또는 `ssh -L 3000:127.0.0.1:3000`)로 여는 것을 권장([docs/deploy-friendly.md](../../docs/deploy-friendly.md)).
...
| `crawl` | 네이버 / DC / 캐치테이블 / **테이블링** 크롤 (Playwright + HTTP 어댑터별 분기, Naver done 후 자동 DC 매칭+머지 후크, naver stealth/jitter, SSE seq 단일화). 테이블링은 무인증 REST(검색/상세/사이트맵 발견). 27차 `43d7e69`: 네이버 메뉴 파서 우선순위 배민 그룹 → `placeMenus`(PlaceMenuItem·PlaceMenuCategory recommend→'대표메뉴'/normal/uncategorized→'메뉴') → 옛 `Menu:` 경로, 홈 응답이 전체 메뉴면 `/menu/list` 생략(9→4초), **메뉴 0건이면 직전 스냅샷 유지 + warn** | [crawl](crawl.md) |
...
| `ai` | LLM 라우팅 + `purpose` 분리(chat/image/log-analysis/meal-photo/meal-recommend/**tarot/saju/saju-g** — 8종) + 모델 preview + **계정 단위 2단 동시성 게이트** + **사용량 텔레메트리 SSE** + 키 1계정 공유·용도별 모델 + `LlmProviderConfig.thinking`(off/low/medium/high/max — kimi 계열만 반영, 그 외 모델은 규칙 `thinkOptionForModel`, 26차 `a823af1`) | [ai](ai.md) |
...
| `saju` | 사주(C)(공개, `/saju-c/*`) — 원국 재계산 → 섹션별 캐시 → 한도 1건 → 섹션 4개 병렬 LLM(purpose `saju`) job 레지스트리 + long-poll(410 = 재시작) → 정적 폴백, 오늘(회원 하루 1회 잠금)·궁합·택일·음식, 프로필 10·기록·공유 카드·OG. 26차 8·9차: 테마 3종 job(`createThemes/pollThemeJob`, 회원은 readingId 행에 병합)·`ask`(사주에 묻기 — 차단→정적·캐시·회원 question 저장)·thinking 배수(maxTokens ×1.5/2/3/5·타임아웃 25s×배수 상한 120s) | [saju-c](saju-c.md) |
...
| `housing` | 집값(공개) — 로컬 DB 조회(status/points/nearby/search/complexes/:id/trades), 적재 서비스(단지·거래·공시가격·K-apt·건축물·파생 통계·지오코딩), `housing-refresh` croner 월 갱신(`HOUSING_REFRESH_CRON`), 어댑터 rtms/kapt/bldg-hub. 26차: 단지 상세 `infra`(반경 500m 편의점·마트·카페·음식점·학원·병의원·약국 개수 — `LifeStore`·`LifeHospital`, LRU 10분, 좌표 없으면 null). 27차: `housing-flood.service.ts` `HousingFloodIndex`(적재된 `LifeFloodTrace` 를 메모리 격자로 — 적재 sync id 가 바뀌면 재구축) → 단지 상세 `flood`(반경 100m 건수·최대 침수심·사건 연월별 내역)·지도 점 `flood` 개수, 흔적 없는 시도는 `null` | [housing](housing.md) |
| `tour` | 여행로그(26차, 20 파일) — export 적재(데이터셋 단위 교체·plausibility·id 접두·sido 파생열·`LifeMasterSync layer=tour\|tour-<key>`)·맛집 매칭·국세청 폐업 조회·어드민 시드 콘솔·원본 열람(`TOUR_RAW_USER_IDS` allowlist, no-store·noindex)·공개 집계(상세 통계·인사이트·코스·밀도·숙소·지역비교 — 식별자 없는 스키마·소셀 억제 5·평점 3·LRU 10분)·region 21키 필터 한 곳. autoload 라우트 3파일(public/admin/raw) | [tour](tour.md) |
...
| `summary` | 리뷰 단위 분석 v4 (메뉴 멘션 + 태그). 27차 `420a6be`: 요약 채널 키를 export `summaryChannelKey`(네이버 = placeId · 다이닝코드 `dc:<vRid>` · 테이블링 `tb:<idx>`) 하나로 — SSE 가 테이블링을 `dc:` 로 구독하던 것·부팅 재큐잉이 `di:`/`ta:` 키를 만들던 것 수정, 중지·재개·재분석은 canonical 전체 출처 | [ai](ai.md) · [canonical](canonical.md) |
| `restaurant` | 어드민 식당 CRUD + 공개 list/detail/insights/ranking (식당명 경량 조회 추가) + 공개 `menu-nutrition`(메뉴 탭 칼로리, 지연 조회, 25차) + 공개 상세/목록/smartPick 에 상가(`store`)·여행로그(`tour`) 결합, 정렬 `tourTravelers\|tourScore`, 전략 `traveler` + `restaurant-store-match.service.ts`(canonical ↔ 상가업소 1:1, 26차). 27차: `restaurant_menus` 를 출처 구분 없이 가게 단위 통째 교체(배민↔일반 전환 잔존 방지, `43d7e69`) · 어드민 상세 `RestaurantDetail` 에 `canonicalId`·`sources`, `reviews` = 같은 canonical 모든 출처(`AdminVisitorReview`), 스냅샷 `visitorReviews` 복제 제거 · 어드민 `place/:placeId/review-match`(공개 리뷰 목록과 같은 팁·메뉴 매칭 — `filterReviewsByTipMenu` 공용화) · 단건 재요약 응답 `canonicalId`(`420a6be`). 맛집 리뷰 '주차' 집계 라우트는 `parking` 모듈이 소유 | — ([canonical](canonical.md) 사이드 테이블 2종) |
...
| `life-map` | 전국 CCTV·공중화장실·병의원·**상가(생활편의, 26차 `LifeStore`)** 로컬 적재 + points/nearby/detail/status + **`crime`**(범죄 통계 배경 — 커밋된 정적 JSON, 26차) + 지역 검색(행정구역·역·정류장·VWorld 주소). 셀 격자 10분 LRU, 요청 경로 외부 호출 0. 적재는 scripts + deploy.sh 자동 점검(26차 상가 zip 포함, 27차 침수 흔적 포함). 여행자 밀도 배경은 `tour` 모듈이 낸다. 27차: `life-flood-master.service.ts` — 서울 침수흔적도 마스터(`LifeFloodTrace`, `LifeMasterSync layer='flood'`)를 이 모듈이 적재하지만 **일상지도 라우트·화면엔 노출하지 않고** 집값이 소비 | [life-map](life-map.md) |
| `sea` | **바다(27차, 공개)** — 국립해양조사원 생활해양예보지수 6종·조석예보·이안류 data.go.kr 프록시(`khoa.adapter` — 봉투에 `response` 감싸개 없음·페이지 순회·재시도). `forecast?activity=`(활동별 전량 1시간 캐시) · `tide?lat&lng&date`(가장 가까운 예보지점, 지점×날짜 12시간), 업스트림 실패 시 12시간 stale. DB·적재 없음, `RATE.transitRealtime` 60/분 | [sea](sea.md) |
| `parking` | **주차(27차, 공개)** — 주차장(표준데이터 + 서울 공영)·전기차 충전소 로컬 적재 조회(점/셀·주변·상세, 1~3시간 예상 요금) + 실시간 폴러(서울 시영·한국공항공사·인천, 5분 — 요일×시 혼잡 이력 UPSERT, 같은 칸 4분 안 재기록 금지) + 충전기 상태 폴러(10분 변경분 → `UPDATE … FROM` 집계). 폴러는 `onListen` 에서만. 맛집 리뷰 '주차' 관점 집계 라우트(`restaurants/public/:placeId/parking-reviews`)도 여기. `RATE.parkingRead` 240/분, 요청 경로 업스트림 0콜 | [parking](parking.md) |
...
| 영역 | 레이아웃 | 라우트 | 가드 |
|---|---|---|---|
| 공개 | `PublicLayout` (TopBar 폭 예산 + lg 미만 드로어 사이드바 — md 미만에선 계정·테마도 사이드바 하단) | `/`, `/restaurants`, `/restaurants-v2`, `/r/:placeId`, `/bus`, `/subway`, `/parking`(27차), `/air`, `/weather`, `/sea`(27차), `/life-map`, `/housing`, `/travel/jeju`, `/travel/plan`(26차), `/tarot`, `/tarot/s/:token`, `/saju-c`, `/saju-c/s/:token`, `/saju-g`, `/saju-g/pair`, `/saju-g/s/:token` | 없음 (여행로그 공개 집계는 `RATE.tourRead` 120/분, 주차 `RATE.parkingRead` 240/분, 바다 `RATE.transitRealtime` 60/분, 타로·사주 LLM 호출은 게스트 키·IP·전역 일일 한도, 옵셔널 인증) |
...
27차부터 이 prefix 분리가 **CORS 경계**도 겸한다 — `/api/v1/admin/**` 만 `PUBLIC_ORIGIN` 으로 닫히고 나머지(공개·로그인 사용자 자원 전부)는 어떤 origin 에서도 호출 가능(`credentials: false`), 외부 문서(`docs/api`)도 같은 선에서 어드민을 뺀다. 문서의 인증 3등급(`공개`·`선택`·`로그인` = `x-auth` public/optional/user)은 이 표의 가드를 swagger transform 이 읽어 붙인 것이다([public-admin-route-split](../concepts/public-admin-route-split.md), [api-docs](api-docs.md)).
...
## Talks To [coverage: high — 27 sources]
...
- **외부 프로젝트(브라우저·서버) → friendly** (27차 `1b621c4`) — 기준 URL `https://ninelife.kr` + `/api/v1/…`, 어드민 외 CORS `*`·credentials 없음, 계약은 `docs/api/openapi.json`(zod 에서 생성). 레이트리밋은 IP 단위(`cf-connecting-ip` 우선)라 브라우저 직접 호출은 사용자 IP 별로, 다른 서버를 거치면 그 서버 IP 하나로 합산된다(README 5절). 공공 API 쿼터·LLM 비용은 이 서버 몫 — [api-docs](api-docs.md)
...
- friendly 내부 — `croner` in-process cron 타이머가 주기마다 menu-grouping → analytics(글로벌 머지) 서비스 호출 (외부 잡 큐 없음 — no-Redis 전제 일관). 27차 주차 폴러 2개(`parking-live` 5분·`ev-status` 10분)도 croner 를 **직접** 쓰고(`scheduleRegistry` 밖, `unref`·`catch`), 서버가 `listen` 할 때만 시작해 결과를 프로세스 메모리(실시간 여석·공항)와 DB(`ParkingOccupancyStat`·`EvStation` 집계)에 둔다
...
- **friendly → data.go.kr 공공데이터포털** — 키는 **계정당 1개**라 25차에 `DATA_GO_KR_API_KEY` **하나로 통일**(`3d9dfed`, 이전 `BUS/AIRKOREA/KMA/HIRA/FOOD_API_KEY` 폴백 체인 폐기). 데이터셋마다 **활용신청만 추가**하면 같은 키: 버스 15000303·15000332 / 에어코리아 15073861(일 500건) / 기상청 단기 15084084·중기 15059468(일 10,000) / 심평원 15001698(적재만, ~80콜) / **국토부 실거래가 15126468(매매 상세)·15126474(전월세)**(적재·월 스케줄러·probe:rtms, 일 10,000 — 24개월 백필 ≈ 12,000콜) / **K-apt 15057332·15058453**(`--source=api`, 일 5,000) / **건축HUB 15134735**(load:housing-buildings, 일 10,000, 단지당 2콜) / 식약처 15100070(**선택** — CSV 배포본이 기본, `fetch:mfds-nutrition` 이 포털 JS 다운로드를 재현). 빈 값이면 해당 라우트 503·스크립트 종료. 어댑터는 에어코리아 패턴(`pageNo/numOfRows`, `callAllPages`, `toServiceKeyPart`, 20s 타임아웃 — 심평원은 40s + 일시 오류 2회 재시도, 응답 본문 코드로 에러 분류)을 공유. 실응답은 `probe:*` 로 `__fixtures__` 에 박음([external-api-proxy-fixture](../concepts/external-api-proxy-fixture.md)). **27차 활용신청 +12**: 바다 8(국립해양조사원 생활해양예보지수 15142484 해수욕·15142490 서핑·15142486 바다낚시·15142489 갯벌체험·15142485 바다갈라짐·15142491 바다여행 + 조석예보 15156018 + 이안류 15156028, `apis.data.go.kr/1192136` — 개발계정 자동승인·각 일 10,000건, 운영계정 전환은 심의지만 갱신당 활동 1~6콜이라 불필요) · 주차 4(전국주차장정보표준데이터 15012896 — `http://api.data.go.kr/openapi/tn_pubr_prkplce_info_api` 평문 HTTP, 한국공항공사 주차 혼잡도 15158689·인천공항 주차 15095047 — 5분 폴러 각 하루 ~288콜, 환경공단 전기차 충전소 15076352 — 적재 ~53콜 + 상태 폴러 ~288콜/일, 개발계정 일 1,000건). KOTSA 주차정보 15099883 은 심의승인 대기(승인되면 원천 추가). `env.ts` 주석 기준 이 키 하나에 걸린 데이터셋은 **25개**(식약처 15100070 은 선택). 두 어댑터 모두 버스 어댑터의 `toServiceKeyPart`(Encoding 키 이중 인코딩 방지)를 재사용
- friendly(적재 스크립트·월 스케줄러) → VWorld 지오코더 — 집값 단지 지번 주소도 일상지도와 **같은 `LifeGeocodeCache`·압축본**에 실린다(운영은 `--offline` 호출 0건, 로컬 온라인 적재 후 `export:life-geocode` 커밋). 27차 주차장 적재(`load:parking-lots` — 좌표 없는 서울 구영 주차장 지번)도 같은 캐시를 쓰지만 `deploy.sh` `parking_data` 가 `--offline` 없이 부르므로 운영 첫 적재에서 VWorld ~700콜이 나간다(재실행은 새 주소만). 메뉴 칼로리는 카탈로그에 없는 음식만 **fatsecret.kr 검색 페이지**를 직접 받아 100g당을 집계(`food-web-estimate.ts`, 어휘당 1회·1초 간격·영구 캐시 — LLM·검색엔진은 숫자 추출에 안 씀) (25차)
- friendly → 기상청 API허브(`apihub.kma.go.kr`, `KMA_APIHUB_KEY` — data.go.kr 와 별개 발급) — AWS 방재기상관측 10분 관측으로 현재 날씨 보강, 비우면 보강만 꺼짐 (신규)
- friendly → **서울 열린데이터광장** (27차에 쓰임새 확장) — `SEOUL_OPEN_API_KEY`("일반 인증키", `http://openapi.seoul.go.kr:8088` 평문 HTTP)는 지하철 역사 마스터(`load:subway-stations`)에 더해 주차 `GetParkInfo`(공영주차장 안내 2,189행 — `load:parking-lots`)·`GetParkingInfo`(시영 실시간 — 5분 폴러)가 쓴다. 빈 값이면 서울 주차장 원천과 실시간 여석이 빠진다(27차에 `.env.example` 에 처음 적힘). 침수흔적도(OA-15636)는 키 없이 `datafile.seoul.go.kr` 폼 POST 로 zip 을 받는다(`load:life-flood`, 적재 스크립트만)
...
- 앱(Expo Web) — dev CORS — friendly 가 dev 한정 모든 origin 허용 (env 안 만지고 폰 단말 LAN 접근 가능). ~~비-LAN 만 origin당 1회 warn~~ — 27차 `1b621c4` 에서 RFC1918 분류·warn 이 사라지고 dev 는 공개 정책 `*`·어드민 반사, prod 도 어드민 외 `*` 로 바뀌었다(위 외부 프로젝트 항목)

스키마 1개 변경으로 FE/BE 모두 컴파일 타임 불일치 감지 — 자세한 건 [api-contract 토픽](api-contract.md).

## API Surface [coverage: high — 36 sources]

루트 `package.json`이 노출하는 명령어 (turbo 위임 — 25~27차 변경 없음):

| 명령 | 동작 |
|---|---|
| `pnpm dev` | 전체 dev (웹 + 앱 + friendly 동시) |
| `pnpm dev:api` | friendly만 (`http://localhost:3000`, docs `/docs` — Swagger UI 는 dev 에서만 등록, 27차에도 유지. 외부용 스펙 파일은 `export:openapi` 산출물 `docs/api/`) |
...
friendly 워크스페이스 스크립트(~~92개~~ → 26차 101 → **27차 107개** — 26차 `match:`·`check:`·`unload:`·`e2e:` 접두 신설, 27차 +6 `export:openapi`(`1b621c4`)·`backfill:naver-menus`(`43d7e69`)·`load:life-flood`(`ad48f96`)·`load:parking-lots`·`load:ev-chargers`·`status:parking`(`2ff2c31`); 대부분 `tsx --env-file=.env` — `build:tarot-deck`·`build:saju-images`·`build:saju-glyphs`·`fetch:mfds-nutrition`·`probe:food-web-estimate` 처럼 DB·키가 필요 없는 것은 `--env-file` 없이)는 접두로 읽는다 — 데이터 운영의 CLI 표면이다 (25차 +25, `build:`·`measure:` 접두 신설):

| 접두 | 예 | 뜻 |
|---|---|---|
| `load:*` | `load:bus-stations` · `load:subway-*` · `load:life-cctv <csv>` · `load:life-toilets <csv> [--offline]` · `load:life-hospitals [--offline]` · `load:food-catalog [--source=nutrition\|raw\|curated\|hansik800\|recipe] [--classify] [--backfill-nutrition]` · **`load:housing-complexes <csv> [--names=<csv>] [--offline] [--skip-derived]` · `load:housing-trades --months=N --recent=N [--max-calls=N] [--offline]` · `load:housing-prices <zip>` · `load:housing-kapt [xlsx \| --source=api --max-calls=N]` · `load:housing-buildings --max-calls=N`**(25차 +5) · `load:tour <절대경로> --dataset jeju\|west\|east\|capital [--dry-run]` · `load:life-stores [zip]`(26차) · **`load:life-flood [dir] [--download] [--refresh] [--dry-run]` · `load:parking-lots [--sources=std,seoul] [--std-json=<파일\|폴더>] [--offline] [--max-calls=N] [--dry-run]` · `load:ev-chargers [--zcode=11] [--max-pages=N] [--dry-run]`**(27차 +3) | 원본/API → DB 전량 교체 적재 (원본은 `data/open/` 기본 경로 — 집값 단지 CSV·공시가격 zip·K-apt xlsx 는 `data/open/housing/`, 실거래는 API 라 파일 없음; 여행로그는 데이터셋 단위 교체; 침수 흔적은 폴더가 비면 스스로 다운로드; 주차장·충전소는 API 만) |
| `status:*` | `status:life-map`(27차 "ok cctv=N toilet=M geocoded=G hospital=H store=S **flood=F** tour=T tour_jeju=… tour_west=… tour_east=… tour_capital=… tour_matched=X cache=C") · `status:food-catalog` · **`status:housing`**(25차 — "ok complexes=N geocoded=G trades=T rents=R prices=P kapt=K from=YYYYMM to=YYYYMM stats=S") · **`status:parking`**(27차 — "ok lots=N std=S seoul=U geocoded=G ev=E chargers=C", `ParkingSync` 최신 행 + `EvCharger` 수) | 적재 상태 한 줄("ok k=v …" / "missing") — `deploy.sh` 가 `stat_val` 로 파싱(키 단위라 항목 추가는 안전) |
...
| `backfill:*` · `eval:*` · `export:`/`import:` · 기타 | `backfill:meal-nutrition` · `backfill:food-allergens` · `eval:meal-recognition` · `export:life-geocode`/`import:life-geocode` · `export:subway-uwp` · **`rebuild:housing-derived` · `geocode:housing-missing [--offline]` · `fetch:mfds-nutrition [--pk=15100065]`**(25차 +3) · `match:restaurant-{tour,stores}` · `check:tour-biz` · `unload:tour --yes [--dataset]` · `e2e:tour` · `build:life-crime`(26차) · **`export:openapi` · `backfill:naver-menus [--dry-run\|--all\|--place=a,b\|--limit=N\|--delay=ms]`**(27차) | 기존 행 보강 / 측정 덤프 집계 / 가공 캐시 압축본 내보내기·가져오기 / 집값 파생 통계 재구축·도로명→지번 변형 좌표 보완 / 포털 JS 다운로드를 재현해 영양성분 CSV 저장(서비스키 불필요) / **외부 API 문서 재생성**(`buildApp` → `app.ready()` 만 — 폴러·서버 bootstrap 은 안 돈다, 어드민·HTML 미리보기 제외해 `docs/api/openapi.json`·`endpoints.md` 기록) / **네이버 메뉴만 재수집**(홈 1장 + 부족할 때만 `/menu/list`, 리뷰·요약·다른 필드 무변경, 기본 대상은 스냅샷 메뉴 0건인 네이버 가게, 가게 사이 3초) |

운영 배포는 루트 `./deploy.sh [1-9]` — 케이스 번호로 골라 실행 (27차 케이스 9 추가 — 머리 주석의 케이스 목록은 아직 1~8, 메뉴·`case` 문은 9까지):
...
| 6 | 일상지도 데이터 적재/갱신 — `data/open/life/*.csv` 새로 올린 뒤 `pull → gen → life_map_data 1`(force, 코드 배포·재기동 없음). 27차부터 force 면 침수 흔적도 `load:life-flood --download`(새 연도 목록 재확인) |
...
| **9**(27차 `2ff2c31`, 2026-09-25) | 주차 데이터 적재/갱신 — 표준데이터·서울 공영주차장·전기차 충전소 API 로 `pull → gen → parking_data 1`(force: `load:parking-lots` + `load:ev-chargers` 둘 다 다시, 코드 배포·재기동 없음). 원천이 반기·수시 갱신이라 가끔 돌린다. 실시간·충전기 상태는 서버 폴러 몫이라 여기선 적재만 |

"데이터 자동 점검" = `life_map_data` + `food_catalog_data` + **`housing_data`**(25차) + **`parking_data`**(27차) — 케이스 1·2·4 체인에서 이 순서로(27차 `parking_data` 는 `housing_data` 뒤·`build_api`/`pm_reload` 앞에 붙었고 케이스 3·5 에는 없다). `life_map_data` 는 27차에 `flood` 값을 읽어 0 이면 `load:life-flood`(실패 시 안내만, 서울 열린데이터 접속 확인), `parking_data` 는 `status:parking` 이 `ok` 가 아니면 "마이그레이션 뒤에 적재" 안내만, `lots`/`ev` 가 0 이면 각각 첫 적재(실패하면 "15012896 활용신청·`SEOUL_OPEN_API_KEY` 확인, 서울만 먼저 `--sources=seoul`" 같은 안내를 찍고 배포는 계속). 공통 규칙: 테이블이 없으면(마이그레이션 전) 안내만, 비어 있으면 첫 적재, 캐시 압축본 변경 시 재적재. 집값은 단지 마스터가 비면 CSV + 지오코딩 캐시 압축본(`--offline`, 호출 0건) 적재, 거래가 비면 최근 `HOUSING_MONTHS`(기본 3)개월만 RTMS 첫 수집, 공시가격 zip·K-apt xlsx 는 파일이 있을 때만 보강, 건축물대장(`load:housing-buildings`)은 쿼터 소모가 커 자동 점검에서 제외(수동). K-apt xlsx 는 포털 파일명(`YYYYMMDD_단지_기본정보.xlsx`)이 날짜로 바뀌므로 glob 사전순 마지막을 고른다 — `ls | tail` 명령 치환은 파일이 없을 때 `set -e` 아래 스크립트를 조용히 죽였다(`b8c08ed`). `pull()` 이 `git diff --name-only prev HEAD -- <gz>` 로 `GZ_CHANGED` 를 채운다. `migrate deploy`(운영) / `migrate dev`(개발) 구분, `pm2` fork 단일 인스턴스(SQLite 락 회피). **nginx 는 deploy.sh 가 건드리지 않는다** — `ops/nginx/niney_life_pickr_v2_projects` 원본을 고쳐 서버로 복사 → `nginx -t` → reload 는 수동. 자세한 절차·nginx·Cloudflare·카탈로그 적재·업로드 파일 백업·사주 글리프는 [docs/deploy-friendly.md](../../docs/deploy-friendly.md).
...
│   ├── crime ..................... 범죄 통계 배경(시군구 등급 — 커밋된 정적 JSON, 26차)
│   └── :layer/:id ................ 상세 (cctv|toilet|hospital|store — store 26차). 침수 흔적(27차 `LifeFloodTrace`)은 이 라우트에 없다 — 집값 응답에만
├── sea/                           바다 — 국립해양조사원 프록시 (공개, 27차; RATE.transitRealtime 60/분, DB 없음) → sea 토픽
│   ├── forecast .................. ?activity=beach|surf|fishing|mudflat|seaSplit|seaTrip — 지점 × 7일 오전/오후 지수(+어종·등급 variants, 해수욕은 6~9월 이안류), 활동별 1시간 캐시·실패 시 12시간 stale
│   └── tide ...................... ?lat&lng&date=YYYY-MM-DD — 가장 가까운 조석 예보지점의 만조·간조(지점×날짜 12시간 캐시)
├── parking/                       주차 — 로컬 적재 + 폴러 메모리 (공개, 27차; RATE.parkingRead 240/분 — status 는 전역 백스톱만, 요청 경로 업스트림 0콜) → parking 토픽
│   ├── status .................... 적재 건수·마지막 폴링 시각
│   ├── lots/points | lots/nearby | lots/:id   ?bbox&zoom(&publicOnly&freeOnly&liveOnly) 점·집계 셀 / ?lat&lng(&radius≤3000&limit≤30) 거리순 / 상세(요금·운영시간·실시간·오늘 요일 평소 혼잡)
│   ├── ev/points | ev/nearby | ev/:id         충전소(필터 fastOnly·freeParkingOnly·availableOnly·openOnly) — 충전기 상태는 10분 폴러 반영
│   └── airports .................. 한국공항공사 13개 공항 + 인천 — 5분 폴러 메모리
├── tour/public/{insights,plan,density,lodging,regions}   여행로그 공개 집계(식별자 없는 스키마·소셀 억제, RATE.tourRead 120/분, 26차) → tour 토픽
...
│   └── complexes/:id(/trades) .... 단지 상세(속성 + 유형×전용면적 구간 통계 + 공시가격 + 26차 `infra` 반경 500m + **27차 `flood`** 반경 100m 침수 흔적 — 서울 밖 null) / 거래 목록(?dealType&band&limit&offset&includeCanceled). 지도 점(`points`)에도 27차 `flood` 개수
...
│   ├── public/:placeId/tour-stats ...... 여행자 탭 집계 (매칭 없으면 404, 26차)
│   ├── public/:placeId/parking-reviews . '가는 법' 주차 — 리뷰 '주차' 관점 긍·부정·중립 건수 + 주차 팁 (공개, parking 모듈 소유, 27차)
...
└── admin/
    ...
    ├── tour/* ..................... 여행로그 시드 콘솔(status·seeds·discover·register·match/run·biz-status/run) + 원본 열람(places/:id/*·trips/:travelId·photos — TOUR_RAW_USER_IDS 밖이면 404, 26차)
    └── restaurants/* .............. 어드민 식당 CRUD + 인사이트 + smart-pick + region-stats + summary SSE — 27차: 상세 응답이 canonical 모든 출처 리뷰(`AdminVisitorReview`)·`canonicalId`·`sources`, `place/:placeId/review-match`(팁·메뉴 필터 매칭 id), 요약 중지·재개·재분석이 **canonical 전체 출처**로(경로 그대로·의미 변경 — 목록 '실패 N' 배지 재분석도 통합), 단건 재요약 응답 `canonicalId`
```

> 27차부터 이 트리의 비-어드민 부분(192 operation)은 `docs/api/endpoints.md`·`openapi.json` 으로 자동 문서화된다 — 인증 등급·레이트리밋 열까지 그쪽이 최신이므로, 경로 전체 목록은 이 요약 대신 그 파일을 본다.
...
PublicLayout  (?embed=1 또는 앱 브리지 주입이면 상단바·사이드바 생략 — 25차)
  ...
  /parking                   ParkingPage (27차 — 탭 주차장|충전소|공항 ?t=, 위치 ?ll&z, 선택 ?sel, 필터 lp:parking-prefs, 지도 + 목록/상세 시트 — 집값·일상지도와 같은 골격)
  ...
  /travel/jeju · /travel/plan   TravelInsightsPage · TravelPlanPage (26차 — 필터 = URL 쿼리, 지역 21키 칩)
  /weather                   WeatherPage
  /sea                       SeaPage (27차 — 활동 ?a × 날짜 ?d × 오전/오후 ?p × 지점 ?sel, 지도 + 순위 목록 그리드·시트 없음)
  /air                       AirQualityPage
...
AdminLayout (RequireAdmin) — 단일 lazy 청크 AdminRoutes
  /admin · discover · auto-discover · restaurants(/:placeId) · crawl-test(/:jobId) · catchtable-test(/:shopRef) · diningcode-test(/:vRid) · tabling-test · diningcode(/:vRid) · tabling · analytics · food · ai-usage · logs(/:runId) · ai-test · review-search · tour(26차) · settings/{ai-keys,map,telegram,logs,quotas(25차)}
  /admin/restaurants/:placeId   27차 재구성 — ?tab= 홈·분석·여행자·메뉴·리뷰·질문·사진·정보·로그 (공개 상세 탭 컴포넌트 재사용, '가는 법' 제외·'질문' 포함), 헤더 출처 행(출처별 수치·다이닝코드/테이블링 재수집)·요약 실패 재분석 배지·공개 화면 링크, 우측 지도·진행 중 크롤/요약 카드 유지
```

라우트 컴포넌트는 `lazy` 코드 스플리팅 — 첫 로드 바이트 절감, `vite.config.ts` 의 `codeSplitting.groups` 가 그 위에 vendor 청크(ol/react-vendor/query/radix + 25차 **three**)를 고정해 앱 코드만 바뀌어도 벤더 캐시 유지. 옛 `/admin/ai-keys` 북마크는 `/admin/settings/ai-keys` 로 redirect. 공개 메뉴(`PublicSidebar.NAV`) 순서는 ~~홈 · 맛집 · 대중교통 · 일상지도 · 집값 · 날씨 · 대기질 · 타로 · 사주(C) · 사주(G)(+ 로그인 시 식단)~~(25차) → 27차 홈 · 맛집 · 대중교통 · **주차** · 일상지도 · 집값 · 여행 · 날씨 · **바다** · 대기질 · 타로 · 사주(C) · 사주(G)(+ 로그인 시 식단), 계정 메뉴에 "내 타로 기록". `/sea`·`/parking` 도 lazy 라우트(App.tsx).
...
사주(G)·집값·여행로그(26차)·바다·주차(27차)는 앱 라우트 없음(미연동 — 27차 앱 변경 0). 앱 부팅(`src/lib/api-setup.ts`)은 `setSettlementDraftStorage` 에 더해 25차 `setGuestKeyStorage`·`setSajuProfileStorage`(AsyncStorage) 를 주입하고 `webUrl`(`EXPO_PUBLIC_WEB_URL`, 없으면 apiUrl 의 `:3000`→`:5173`) 을 계산한다.

## Data [coverage: high — 33 sources]
...
| 웹 localStorage | `lp:parking-prefs` (v1) | 주차 필터 — 주차장 공영만·무료만·실시간만 / 충전소 급속·주차료 무료·사용 가능·제한 없음(`apps/web/src/stores/parkingPrefsStore.ts`, 27차). 위치(`ll`,`z`)·탭(`t`)·선택(`sel`)은 URL 이 진실 — housingPrefsStore 관례. 바다(`/sea`)는 저장소 없이 URL(`?a&d&p&sel`)만 |
...
| friendly 프로세스 메모리 | 공공 API 응답 캐시 | 에어코리아(측정 10분/예보 20분/주간 60분/측정소 24h), 기상청(발표 시각 단위, 폴백 시 5분), 일상지도 셀 LRU(10분), **바다**(활동별 전량 1시간 · 물때 지점×날짜 12시간 · 업스트림 실패 시 12시간 stale, 27차) — 재시작 시 리셋 |
| friendly 프로세스 메모리 | 폴러 상태 · 격자 색인 (27차) | 주차 실시간(서울 시영 여석·한국공항공사·인천 — `parking-live` 5분 폴러가 채움, 재시작하면 기동 직후 1회 폴링으로 복구) — 혼잡 이력은 DB(`ParkingOccupancyStat`) 로 누적 / `HousingFloodIndex`(적재된 `LifeFloodTrace` 메모리 격자 — 최신 `LifeMasterSync layer='flood'` id 가 바뀌면 재구축, 동시 호출은 한 번만 짓는다) |
...
### 도메인 테이블 그룹 (전 **113** 모델, 마이그레이션 **88**개 — 25차 +18 모델·+11, 26차 +14 모델·+6, 27차 +6 모델·+2)

> 27차 컴파일에서 표를 실제 `schema.prisma` 와 대조해 보강했다 — 26차 모델 14개(여행로그 11·상가 매칭 2·`LifeStore`)가 표에 빠져 있었고, 처음부터 빠져 있던 `RestaurantMenuGroup`·`RestaurantMenu`·`CrawlJobLog` 를 채웠으며, 청크 캐시 모델명을 `GlobalMergeChunkCache` 로 바로잡았다(표에 `GlobalMenuMergeChunkCache` 로 잘못 적혀 있었다).
...
| 일상지도 (7) | `LifeCctv`, `LifeToilet`, `LifeHospital`(`20260827222827`), `LifeGeocodeCache`(주소→좌표 영구 캐시, notfound 포함 — 25차부터 집값 단지 지번, 27차부터 주차장 서울 구영 지번도 여기), `LifeMasterSync`(layer 별 최근 적재 건수 — `status:life-map` 의 원천, 27차 layer `flood`) `20260821130000` · **`LifeStore`**(26차 — 상가 관심 업종 9종 1,307,626행, `@@index([kind,lat,lng])`, `20260912101013_add_life_store_and_restaurant_store_match`) · **`LifeFloodTrace`**(27차 `life_flood_traces` — 필지 무게중심 lat/lng·`eventYear`/`eventMonth?`·`depthM?`·disaster/cause/kind 원문·`sggCd`(시도 커버리지 판정)·`sourceYear`, `@@index([lat,lng])`, 주소·필지 컬럼 없음, `20260924080000_add_life_flood_traces`) |
| **맛집 사이드 매칭 (2, 26차)** | `RestaurantStoreMatch`(`canonicalId @id`·`bizesId` — 상가 80m·상호 0.5, `20260912102150` 에서 상가 FK 제거), `RestaurantTourMatch`(`canonicalId @id`·`tourPlaceId @unique` — 여행로그 100m·상호 ≥0.5) — [canonical-side-table-match](../concepts/canonical-side-table-match.md) |
| **여행로그 (11, 26차)** | `TourPlace`·`TourTrip`·`TourVisit`·`TourActivity`·`TourSpend`·`TourTransition`·`TourDaySequence`·`TourCompanion`·`TourPhoto`(9표 모두 `dataset` 열 기본 `'jeju'` + `@@index([dataset])`, FK 없음) + `TourCode`(공용 코드표) + `TourPlaceBizStatus`(`placeId @id`, 국세청 사업자 상태) — `20260913062022_add_tour_log`·`20260913064102_add_tour_match_biz`·`20260915185047_add_tour_dataset_multi` — [tour](tour.md) |
| **주차 (5, 27차)** | `ParkingLot`(`id` 원천 접두 `std:`/`seoul:`, `source` std\|seoul\|kotsa, 요금(분·원)·운영시간(평일/토/공휴일)·`satFree`/`holFree`·`liveKey`·`geoSource`(source\|road\|parcel), `@@index([lat,lng])`·`[liveKey]` — 전량 교체), `ParkingOccupancyStat`(`@@id([key,dow,hour])` samples·occSum·fullCount(점유 97%↑) — 요일×시 혼잡 누적, 상한 키 수×168), `ParkingSync`(kind `lots`\|`ev` 적재 이력·detail JSON — `status:parking` 원천), `EvStation`(충전기 수·급속 수·사용 가능/충전 중 집계·`statusAt` — 상태 폴러 갱신), `EvCharger`(`@@id([statId,chgerId])`, 상태·원천 시각 문자열 그대로) — `20260925071552_add_parking`(전부 `CREATE TABLE`) — [parking](parking.md) |
...
| 식당/크롤 (6) | `Restaurant` ((source, sourceId) unique + canonicalId), `VisitorReview`, `ReviewSummary` + (27차 컴파일 보강) `RestaurantMenuGroup`(`@@unique([restaurantId,source,sourceGroupId])` — 네이버는 27차부터 `placeMenus` 카테고리에서 recommend→'대표메뉴'·normal→원래 이름·uncategorized→'메뉴'), `RestaurantMenu`(27차 `43d7e69`: 출처 구분 없이 가게 단위 통째 교체 — 쓰기 전용이라 0건 사고의 복구원이 못 됐다), `CrawlJobLog`(`@@index([jobId,createdAt])`·`[placeId,createdAt]`) |
...
| 전역 머지 + 통계 (3) | `GlobalMenuCanonical`, `GlobalMenuCanonicalLink`, `GlobalMergeChunkCache`(~~`GlobalMenuMergeChunkCache`~~ 정정 — 테이블 `global_merge_chunk_cache`, `cacheKey @unique`) (청크 캐시 — `20260619075115`(`_add_random_crawl`) 마이그레이션 정식 등재. 과거 수동 생성 운영 DB 는 `_prisma_migrations` 정합 확인 필요) |
...
자세한 모델·인덱스: [friendly](friendly.md), [canonical](canonical.md), [settlement](settlement.md), [housing](housing.md), [tarot](tarot.md), [saju-c](saju-c.md), [saju-g](saju-g.md), [usage-quota](usage-quota.md), [food](food.md), [tour](tour.md), [life-map](life-map.md), [parking](parking.md). 바다([sea](sea.md))는 테이블이 없다.

**27차 데이터 규모(로컬 적재 실측, 작업 기록·커밋 본문)**: `LifeFloodTrace` 43,112점(2026-09-24, 최신 사건 2025-09) · `ParkingLot` 18,168(서울 835 + 표준 17,333, 겹침 413 제외, 좌표 96% — 같은 날 표준데이터 API 승인 후 API 경로 재적재 18,167·겹침 414) · `EvStation` 99,850 / `EvCharger` 515,263(53콜 43초, 교체 21초) · 실시간 서울 99곳 + 공항 44구역, 충전기 상태 10분 폴링 1회 ~1만 곳 갱신. `docs/api/openapi.json` 은 커밋되는 생성물(53,919줄)이다.
...
| 결정 | 이유 |
|---|---|
| **2026-09-26 — 어드민 맛집 상세는 공개 상세 탭을 재사용하고, 리뷰·요약 운영은 canonical 의 모든 출처를 대상으로 (`420a6be`, 사용자 결정 A안)** | 초기 어드민 상세는 네이버 행 하나만 읽어 다이닝코드·테이블링 리뷰와 그 요약 실패가 안 보였고(특돼지 목동점 네이버 38 vs 테이블링 508), 이후 기능(AI 집계·주제 군집·메뉴 그룹·칼로리·질문)은 공개 상세에만 있었다. 운영 골격(헤더의 업데이트/재크롤링/삭제·진행 중 크롤/요약 카드·우측 지도)은 두고 본문을 공개 탭 구성(`?tab=` 홈·분석·여행자·메뉴·리뷰·질문·사진·정보·로그 — '가는 법' 은 운영 가치가 낮아 제외, '여행자' 는 매칭 있을 때만)으로. 홈·분석·사진·질문은 공개 컴포넌트 그대로(공개 `HomeTab` `availableTabs`·`ParkingSummaryLine` `onOpen` 은 **선택 prop** 으로 열어 공개 동작 불변), 리뷰 탭은 출처 통합 + 기존 필터 + 출처·감정·본문 검색·단건 재요약. **요약 중지·재개·재분석을 canonical 전체 출처로 넓힌 것은 기존 엔드포인트의 의미 변경**(경로 그대로 — 목록 '실패 N' 배지 재분석도 통합)이고, 헤더엔 다이닝코드·테이블링 재수집만(분리·병합은 목록 화면). 부수 효과로 요약 채널 키 `summaryChannelKey` 통일 등 기존 버그 4건 수정, 오복솥뚜껑 응답 689KB → 479KB(스냅샷 리뷰 복제 제거). 후속 미결: 공개 인사이트가 네이버 행만 집계(Gotchas), 상세 삭제 범위 — [canonical](canonical.md), [canonical-corpus-fanout](../concepts/canonical-corpus-fanout.md) |
| **2026-09-25 — 격리 DB 준비 훅 한도는 60초, 테스트 파일 직렬 실행은 유지 (`5d7b686`)** | `useIsolatedDatabase()` 가 dev.db(3.6GB)를 통째로 복사해 비우느라 기본 10초 훅 한도를 넘겨, 파일 캐시가 차가운 전체 실행에서 간헐 실패(restaurant ranking 등)했다. 격리 방식(실 스키마·실 인덱스를 그대로 쓰는 복사)을 바꾸지 않고 `vitest.config.ts` `hookTimeout: 60_000` 만 — 파일별 180초 예외(`parking.test.ts`)는 전역 설정으로 흡수. `fileParallelism: false`(SQLite 락 회피)는 그대로. 결과 friendly 143파일·1,522 통과 |
| **2026-09-25 — 주차는 일상지도 레이어가 아니라 별도 메뉴 · 지도+패널 3탭 · 혼잡 이력은 지금부터 축적 · 체류 시간별 요금 정렬은 안 함 · 웹 먼저 (`2ff2c31`, [docs/PLAN-parking.md](../../docs/PLAN-parking.md) 결정 표)** | 주차장·충전소·공항은 필터·실시간·상세가 커서 일상지도 점 레이어 하나로 담기 어렵다 → `/parking`(사이드바 대중교통 다음), 탭 주차장\|충전소\|공항, 집값·일상지도와 같은 지도+시트 골격([map-sheet-shell](../concepts/map-sheet-shell.md)). 맛집과의 연결은 '가는 법' 탭 섹션 + 홈 탭 한 줄. 혼잡도는 원천이 "지금 몇 대"뿐이라 5분 폴링을 요일×시간 칸에 누적해 **평소 혼잡도를 스스로 만든다**(표본이 쌓이면 자동 표시). 요금은 상세의 1~3시간 예상 요금까지만. KOTSA 15099883(실시간 실연계 ≈4.2천·더미성 행 다수)은 심의 승인 후 재프로브. 앱은 다음 단계 |
| **2026-09-25 — 서버 폴러는 `onListen` 에서만 시작하고 테스트에선 cron 을 비운다 (`2ff2c31`)** | 같은 `buildApp()` 을 `export:openapi`(`app.ready()` 만)·inject 테스트 143파일이 공유하므로 `onReady` 에 폴러를 걸면 스펙 한 번 뽑거나 테스트를 돌릴 때마다 업스트림 쿼터(인천·충전기 개발계정 1,000/일)가 깎인다. 포트를 실제로 여는 서버만 폴링 — 서버 bootstrap(`server.ts`, listen 전) · `onReady`(집값 월 갱신·군집 리컨실) · `onListen`(주차 2종) 세 지점의 구분이 컨셉 [server-only-boot-effects](../concepts/server-only-boot-effects.md) 로 정리됐다. `PARKING_LIVE_CRON`·`EV_STATUS_CRON` 은 기본 켜짐, 빈 값이면 끔 |
| **2026-09-25 — 네이버 메뉴 0건은 저장하지 않는다(직전 스냅샷 유지 + warn) + 메뉴만 다시 받는 백필 (`43d7e69`)** | 네이버가 메뉴 Apollo 구조를 `placeMenus` 로 바꾸자 파서가 에러 없이 0건을 냈고, 재크롤이 기존 스냅샷 메뉴까지 `[]` 로 덮었다 — `restaurant_menus` 는 쓰기 전용이라 복구원도 못 됐다. 구조 변경은 또 온다고 보고 **"0건 = 의심"** 규칙을 넣었다: 크롤 결과 메뉴 0건이면 직전 스냅샷 유지 + 크롤 로그 warn("메뉴 0건 — 네이버 메뉴 구조 변경 의심"), 매 크롤 메뉴 출처·개수 로그, 메뉴 탭이 있는데 0건이면 warn. 파서는 배민 그룹 → `placeMenus` → 옛 `Menu:` 순, 카테고리 매핑(recommend→'대표메뉴' — 웹 HomeTab 이 이 이름을 찾는다)은 사용자 확정. 복구는 리뷰를 건드리지 않는 `backfill:naver-menus`(운영은 배포 후 `--dry-run` → 실행). DB·계약 변경 없음 — [crawl](crawl.md), [menu-grouping](menu-grouping.md) |
| **2026-09-24 — 어드민 외 API 는 CORS `*` + `credentials: false`, 어드민만 `PUBLIC_ORIGIN` — 보안 감사 #42 fail-closed 번복 (`1b621c4`, 사용자 결정)** | "내 다른 프로젝트에서 쓸 것 — 운영도 CORS 다 풀고, 트래픽 보고 나중에 제한. 어드민 제외, 열 수 있는 건 다 열기(LLM 포함)". #42 가 막으려던 것은 "`*` 반사 + `credentials: true` 로 타 사이트가 사용자 세션으로 호출" 인데, 인증이 `Authorization: Bearer` 헤더뿐(쿠키 없음)이라 credentials 를 끄면 그 위험이 사라진다. 남는 위험은 **비용**(LLM·업스트림 쿼터 소진, IP 분산으로 IP당 레이트리밋이 약해짐) — 트래픽을 보고 prod `CORS_ORIGIN` 목록으로 좁힌다. 어드민은 같은 origin 웹만 쓰므로 방어심층으로 닫고, 퍼센트 인코딩 경로도 어드민으로 판정. 번복 기록은 [docs/PLAN-perf-security.md](../../docs/PLAN-perf-security.md) #42 아래(2026-05-31 "dev 전면 반사" 결정은 이 정책에 흡수) |
| **2026-09-24 — 외부 API 문서는 zod SSOT 에서 생성한다: 수기 README 1 + 자동 `openapi.json`·`endpoints.md` + CLAUDE.md 6번 규칙 (`1b621c4`)** | 문서를 따로 쓰면 코드와 어긋난다 — 이미 zod → fastify-type-provider-zod 로 검증하던 스키마를 `@fastify/swagger` 로 그대로 내보내고, 사람이 적을 것은 라우트 `summary`(한국어)와 공통 규칙(README)뿐. 인증 등급·레이트리밋은 swagger transform 이 라우트 훅·config 에서 자동으로 읽어 붙이므로 손으로 표기하지 않는다(선택 인증만 `OPTIONAL_BEARER` 명시). 스펙 생성기는 전 환경 등록하되 HTTP 로 노출하지 않고(`/docs` UI 는 dev 만 — 감사 #44 유지), `export:openapi` 는 listen 없이 `app.ready()` 만. `src/plugins/` 에 `*.test.ts` 를 두면 autoload·tsup 이 플러그인으로 올리므로 앱 연결 테스트는 `src/app.*.test.ts` — 이 셋을 CLAUDE.md 6번으로 굳혔다 — [api-docs](api-docs.md), [zod-ssot-buildless](../concepts/zod-ssot-buildless.md) |
| **2026-09-24 — 바다는 별도 페이지 `/sea`(날씨 옆), 적재 없이 프록시 + 메모리 캐시, 지점 좌표표만 커밋, 웹 먼저 (`4a2bff1`)** | 생활해양예보지수는 활동별 7일 예보 전량이 한 번에 오는 작은 데이터라 적재할 이유가 없다 — 활동별 1시간·물때 지점×날짜 12시간 캐시 + 업스트림 실패 시 12시간 stale(개발계정 일 10,000건에 갱신당 1~6콜). 어종·등급 행을 슬롯 하나의 `variants` 로 접어 바다낚시 응답 440→196KB. 가이드 코드표엔 지점 좌표가 없어 지점별 1회 호출로 모은 좌표(조석 166·이안류 10)를 utils 에 커밋. 날씨 해상 중기예보(`?sea=` 해역·파고)와는 원천·용도가 달라 합치지 않았다. 앱은 미구현 — [sea](sea.md), [external-api-proxy-fixture](../concepts/external-api-proxy-fixture.md) |
| **2026-09-24 — 침수 흔적은 집값 단지 상세·지도 배지로, 반경 100m, 건수 + 사건 연월 내역만(주소·필지 비노출), DB 테이블 + 자동 다운로드 적재 (`ad48f96`, 사용자 결정)** | 서울 아파트 9,783단지 실측으로 반경을 골랐다 — 100m 면 1건 이상 55%·중앙값 1건·상위 10% 9건↑, 50m 는 큰 단지 안쪽 흔적을 놓치고(27%) 200m 는 80% 가 걸려 변별력이 없다. 물방울 2단계(1~4 / 5↑ ≈ 상위 21%)와 회색 점(거래 없는 단지) 제외는 구현자 결정. 흔적 데이터가 개인 필지 단위라 개수·연월·침수심만 내보내고, 흔적이 없는 시도는 0 이 아니라 `null`(모름). 원천이 로그인 없이 받아지므로 적재기가 직접 내려받는다(첫 "자동 다운로드 적재") — [housing](housing.md), [life-map](life-map.md), [open-data-master-load](../concepts/open-data-master-load.md) |
| **2026-09-12~19 — 여행로그는 "한 DB, 두 출구"·데이터셋 단위 교체·공개 노출은 AI 허브 서면 회신 뒤 (26차, 27차 컴파일에서 표 보강)** | 26차 결정은 Architecture "여행로그 — 한 DB, 두 출구" 소절이 원문이다 — 이용조건(원본 제3자 제공·국외 반출 금지, 집계는 출처 표기 시 자유)이 공개 집계(식별자 없는 스키마·소셀 억제)와 allowlist 원본 열람을 가르고, export 는 `load:tour --dataset` 으로 세트만 교체, 공개 화면은 서면 회신 전 운영 반입 보류가 실제 게이트 — [tour](tour.md), [docs/PLAN-tour-log.md](../../docs/PLAN-tour-log.md) |
...
| **2026-08-22 — 공공데이터 원본은 리포 밖 `data/open/`, 가공 캐시만 커밋, deploy 자동 점검 (`809b7e0`·`5a84b63`·`dae1cc9`)** | 79MB CSV·91MB 평가셋을 git 에 넣지 않는다. 원본은 로더 입력일 뿐이라 갱신 때만 필요 → 보관 기준은 "다시 받기 난이도". 로더가 `data/open/…` 을 기본으로 찾아 인자 없이 재적재, `status:*` 한 줄을 deploy.sh 가 파싱해 비었을 때만 자동 적재(잘못 재적재하면 LLM 분류를 통째로 다시 도니 상태 해석 실패는 skip). 지오코딩 결과(VWorld 일일 한도 소모물)는 `json.gz` 로 커밋해 서버에서 업스트림 0건으로 재현 — [docs/data-sources.md](../../docs/data-sources.md). 25차에 집값(`data/open/housing/`, 케이스 8)과 이미지 원본(`assets-src/`)이 같은 원칙에 합류, 27차에 침수 흔적(`data/open/flood/` — 비어 있으면 적재기가 직접 다운로드)이 합류 |
...
| **2026-08-22 — DB 를 건드리는 테스트는 `useIsolatedDatabase()` 필수 (`517e465`)** | 테스트가 `.env` 의 `DATABASE_URL`(운영 스냅샷)을 그대로 쓴다. analytics 글로벌 머지 테스트 한 블록이 격리를 안 써 `pnpm --filter friendly test` 한 번이 머지 결과(5,446 그룹 + 링크 22,303 + 청크 캐시)를 통째로 날렸고 LLM 1,352콜로 복구했다. 격리하면 실데이터 전제(두 패스 변형 목록 상이)가 깨지므로 픽스처로 재현해야 한다. 25차 사주(G) 세션이 `useSchemaDatabase()`(현재 schema 로 빈 임시 DB, 실데이터 복사 없음) 를 추가해 C/G 테스트가 쓴다. 경고는 docs/data-sources.md 에도. **27차 두 번째 사고**(`420a6be`): 서버 부팅 정리 함수 `cleanupStaleReviewSummaries` 의 테스트가 DB 전역의 queued/pending/running 요약을 `failed(server_restart)` 로 바꿔 실 dev.db 에서 기다리던 요약을 뒤집었다(작업 기록: 한 가게 533행 — dev 서버 재시작 때 자동 재큐잉으로 회복) → 그 describe 블록을 격리 DB 로 옮겼다. 교훈: "행을 만들고 지우는 테스트"만이 아니라 **DB 전역을 쓸어 담는 함수의 테스트**도 격리 대상 |
| **2026-08-22 — 상단바 폭 예산 + 모바일(웹 작은 화면) 계정·테마는 사이드바 하단 (`a062e7d`)** | 내 위치 칩(모바일 ~170px / lg+ ~340px)이 들어오자 375px 에서 문서가 465px 로 넘쳐 테마·로그인이 화면 밖으로 밀리고 `fixed inset-x-0` 레이어(맛집 지도·시트)까지 문서 폭을 따라 커졌다. 폭 구간별 담는 것을 나눔 — `<md` [≡][로고]…[칩] / `md~lg` +테마·계정 메뉴 / `lg+` NAV 가로 + 칩 확장 / `xl+` 이메일. 로그인 사용자는 `AccountMenu`(헤드리스 디스클로저) 하나. 넘치면 버튼 대신 칩이 줄어들게(왼쪽 shrink-0 / 오른쪽 min-w-0). 25차에 NAV 가 10개로 늘었다 — 26차 11개, 27차 13개(+로그인 시 식단 14). `PublicTopBar.tsx` 폭 예산 메모는 여전히 "lg+ NAV 7개 가로 표시, 7번째 '집값' 은 1024 에서도 칩·테마·계정과 한 줄"이고 "라벨을 늘리면 lg 구간을 재실측할 것"이라 적었는데 재실측 기록이 없다(Gotchas) |
| **2026-08-22 — 지도형 공개 페이지 모바일은 맛집 v2 바텀시트 패턴으로 통일 (`e84e4b9`)** | `BottomSheet` 를 `restaurant-v2/` → `sheet/` 로 승격, 목록/상세 두 시트 스냅 조율을 `useMapSheets` 로 — 대중교통·일상지도·맛집 v2·**집값(25차)**·**주차(27차)** 가 같은 훅(바다 `/sea` 는 예외 — 지도 360px + 목록 그리드의 문서 스크롤). 분기는 CSS 이중 마운트 대신 JS(`useIsDesktopXl`) → 지도 한 장·패널 한 벌. 지도 하단 컨트롤은 `--map-bottom-inset` 만큼 올라와 peek 시트에 안 가림. React Compiler 메모 검증 때문에 `useMapSheets` 는 각 페이지 `useState` 앞에 |
...
| **dev CORS 전면 반사 허용 (preflight 차단 해소)** — 2026-09-24 `1b621c4` 로 대체 | 개발 머신 IP 가 공인/사설/VPN/WSL 로 수시로 바뀌어 화이트리스트 무의미. 거부(`cb(Error)`)가 로그인 preflight(OPTIONS)를 통째로 깨던 회귀 해소. dev 한정 모든 origin 반사, 비-LAN 만 origin당 1회 warn. prod 는 env `CORS_ORIGIN` 엄격 차단(보안 영향 0). **현재**: dev 는 공개 `*`·어드민 반사(warn 없음), prod 도 어드민 외 `*` + credentials false — 위 2026-09-24 행 |
...
11. **지도형 공개 페이지(맛집 v2·대중교통·일상지도·집값·주차(27차))는 v2 시트 패턴** — 바다(27차 `/sea`)는 지도 높이를 고정한 그리드(모바일 360px 지도 아래 목록, lg+ 지도 600px · 목록 380px 두 칸)라 이 예외가 아니라 규율 1(body 스크롤)을 따른다. 시트 패턴은 `fixed` 지도 배경 + `components/sheet/BottomSheet`(3-snap) + `useMapSheets` 목록/상세 조율, 데스크톱/모바일 분기는 `useIsDesktopXl`(JS) — 규율 1 의 예외이며 명세는 [docs/mobile-public-restaurant-ux-v2.md](../../docs/mobile-public-restaurant-ux-v2.md)
12. **상단바는 한 줄 폭 예산** — 넘치면 오른쪽 끝이 화면 밖으로 밀리고 문서가 가로 스크롤돼 `fixed inset-x-0` 레이어까지 커진다. 요소를 더할 땐 `PublicTopBar.tsx` 상단 폭 예산 메모(`<md`/`md~lg`/`lg+`/`xl+`)에 맞춰 넣고, md 미만에 안 들어가면 `PublicSidebar` 하단으로. 27차 NAV 는 13개(+식단) — lg+ 에서 전부 가로로 펼치는 구조(`nav` 가 `shrink-0` 묶음 안)라 1024~1279px 에서 칩·테마·계정과 한 줄에 드는지 재실측 대상(메모는 아직 "NAV 7개")
...
## Gotchas [coverage: high — 44 sources]

- **운영 배포 체크리스트 — 27차 (운영 메모 — 로컬 `origin/main` 추적 기준 `5d7b686` 까지 push 됨·`420a6be` 는 로컬만, 작업 기록상 운영 배포 전)** — ① **마이그레이션 2개**(`20260924080000_add_life_flood_traces`·`20260925071552_add_parking`, 둘 다 `CREATE TABLE`/`CREATE INDEX` 만 → 케이스 2/4 무중단). ② **`.env`**: `CORS_ORIGIN` — 26차까지 `.env.example` 값이 `http://localhost:5173,http://localhost:8081` 이었으므로 그 값을 복사해 둔 운영 `.env` 면 어드민 외 API 가 **그 두 localhost origin 에만** 열린다(= 외부 개방 안 됨) → `*` 로 바꾸거나 줄을 지운다(env 기본 `*`). 기동 로그 `CORS: 어드민 외 … 허용, 어드민은 … 만` 한 줄로 확인. `SEOUL_OPEN_API_KEY` 가 비면 서울 주차장 원천·시영 실시간 여석이 빠진다(지하철 역사 마스터에 쓰던 그 "일반 인증키"). `PARKING_LIVE_CRON`·`EV_STATUS_CRON` 은 **줄이 없으면 기본값(5분·10분)으로 켜지고**, `PARKING_LIVE_CRON=` 처럼 빈 값을 적어야 꺼진다. 그 뒤 `pm2 reload --update-env`. ③ **data.go.kr 활용신청 +12**(바다 8·주차 4 — 전부 자동승인, 미신청이면 `30`), KOTSA 15099883 은 심의 대기. ④ **적재**: 케이스 1·2·4 가 `flood=0`·`lots=0`·`ev=0` 이면 자동 — 침수 흔적은 서버가 서울 열린데이터에서 zip 을 직접 받고(수 초), 주차장은 서울 구영 지번 지오코딩으로 **VWorld ~700콜**(`--offline` 아님), 충전소 ~53콜(1분 남짓). 주차 원천 갱신은 `./deploy.sh 9`. 침수 흔적 새 연도는 `./deploy.sh 6` 도 되지만 케이스 6 은 **일상지도 전체 force**(CCTV·화장실·병의원 API·상가 zip·여행로그 전 세트까지 재적재)라 무겁다 — `pnpm --filter friendly load:life-flood --download` 단독 실행이 맞다. ⑤ 배포 후 `pnpm --filter friendly backfill:naver-menus --dry-run` → 실행(운영 백필 대기, 작업 기록 — 비배민 가게에 새 카테고리 그룹을 입히려면 `--all`, 가게당 ~4초 + 지연 3초). ⑥ 서버는 listen 직후 주차 실시간을 1회 폴링하고 5분마다(로그 `[parking] 실시간 폴러 등록`), 충전기 상태는 10분마다 — 외부 콜이 배포 즉시 시작된다. nginx 변경은 없다(`/sea`·`/parking` 은 SPA 폴백으로 충분)
- **`docs/api` 재생성은 손으로 한다 — 그리고 수기 README 는 재생성 대상도 아니다 (27차)** — CI 가 없고(`.github/` 없음) `app.openapi.test.ts` 는 transform 규칙(`x-auth`·`x-rate-limit`·`/docs` 비-dev 미등록)만 검사해, 라우트를 바꾸고 `export:openapi` 를 잊어도 아무것도 깨지지 않는다(CLAUDE.md 6번이 유일한 안전장치). 이미 어긋난 자리: [docs/api/README.md](../../docs/api/README.md) 파일 표는 `endpoints.md` 를 "(183개)" 라 적었지만 `2ff2c31` 재생성 뒤 192개이고, 6절 도메인 개요·5절 레이트리밋 대표값 표에 **주차가 없다**(`2ff2c31` 은 자동 두 파일만 재생성, README 는 `1b621c4` 이후 무변경). `x-guest-key` 같은 헤더는 zod 스키마에 선언돼 있지 않아 스펙에 안 나온다(README 9절 — 외부 타입 생성으론 못 잡음). 스펙은 zod→JSON Schema 변환이라 재귀 트리(`category-tree` `children`)는 `any`
- **문서·주석과 코드가 어긋난 자리 (27차 컴파일에서 확인)** — ① `deploy.sh` 머리 주석의 케이스 목록은 1~8 이고 자동 점검 설명에도 주차·침수가 없다(메뉴 heredoc·`case` 문은 9까지, 동작은 정상). `life_status()` 위 주석의 상태 줄 예시에도 `flood=` 가 없다. ② `PublicTopBar.tsx` 폭 예산 메모 "lg+ : NAV 7개 가로 표시 … 7번째 '집값' 은 1024 에서도 칩(~340px)·테마·계정과 같은 줄" — NAV 는 27차에 13개(+로그인 시 식단)이고 메모 스스로 "라벨을 늘리면 lg 구간을 재실측할 것"이라 했는데 재실측 기록이 없다(1024~1279px 에서 한 줄 초과 가능성 — 육안 미확인). ③ `apps/friendly/src/config/env.ts` 의 `SEOUL_OPEN_API_KEY` 주석은 여전히 "openapi 정적(역사마스터) — load:subway-stations 가 사용" 뿐(주차 적재·폴러도 쓴다 — `.env.example` 쪽은 27차에 갱신). ④ `scripts/life-map-status.ts` 머리 주석의 출력 예시에 `tour_capital` 이 없다(실제 출력은 `TOUR_DATASET_KEYS` 로 자동이라 포함). ⑤ `App.tsx` 의 "일상지도 … OL 지도라 lazy" 주석이 `/parking` 라우트 위로 밀렸고, `packages/api-contract/src/routes.ts` 의 "── 일상지도 …" 머리 주석이 `Parking` 블록 위에 붙어 있다(블록 삽입 위치). ⑥ `.gitignore` 의 `/data/` 주석 목록엔 food·life·flood·eval 만 있고 housing·tour·store·crime 폴더는 없다(`/data/` 한 줄이 전부 덮어 동작 무관). ⑦ [docs/data-sources.md](../../docs/data-sources.md) 에 주차 원천이 없다 — 파일 없는 API 적재라 보관표 대상은 아니지만 바다처럼 "API 만" 문단도 없어, 표준데이터를 `--std-json` 파일로 넣는 경로가 이 문서엔 안 보인다
- **로컬 dev 서버도 같은 키로 폴링한다 — 개발계정 쿼터가 두 배로 빠진다 (27차, [docs/PLAN-parking.md](../../docs/PLAN-parking.md) 호출량 절)** — 주차 실시간 5분 폴러는 서울·한국공항공사·인천 각 하루 288콜, 충전기 상태 10분 폴러도 하루 ~288콜인데 인천공항·충전기는 개발계정 **일 1,000건**. 운영과 로컬 dev 서버(`pnpm dev:api`)가 같은 `.env` 키로 동시에 돌면 두 배, dev 를 여러 대 띄우면 그만큼 더. 로컬에선 `.env` 에 `PARKING_LIVE_CRON=`·`EV_STATUS_CRON=`(빈 값)으로 끄는 편이 안전하다. 테스트는 `isTest` 로 cron 을 비워 등록 자체를 안 하고, `export:openapi`·inject 는 `onListen` 이 없어 안 돈다
- **테스트 인프라 함정 — 27차에 드러난 셋 (`5d7b686`·`420a6be`, 작업 기록 `ad48f96`)** — ① `useIsolatedDatabase()` 는 dev.db(3.6GB)를 통째 복사해 비우므로 준비 훅이 기본 10초를 넘긴다 → `vitest.config.ts` `hookTimeout: 60_000`. 파일 캐시가 차가운 **전체 실행**에서만 간헐 실패해 단독 실행으로는 재현이 안 된다(`restaurant` 는 단독 통과). ② 격리 DB 에는 테스트가 만든 행만 있다 — `meal-recognition.service.test.ts` 는 없는 `rec-user` 로 사진을 저장해 `MealPhoto → User` FK 위반으로 **늘 실패**했는데 두 커밋 본문(`43d7e69` "기존 별건", `2ff2c31` "주차와 무관")이 넘겼다 → `5d7b686` 이 `beforeAll` 에서 사용자 생성. ③ 로컬 dev 서버가 DB 를 잡고 있어 `migrate deploy` 가 잠기면 SQL 을 직접 돌리고 `_prisma_migrations` 에 수동 행(`started_at` 정수 ms, `checksum` = sha256)을 넣게 되는데, 그 뒤 **WAL 체크포인트 필수** — 격리 DB 는 dev.db 본체만 복사하므로 새 테이블이 WAL 에만 있으면 테스트 DB 에서 빠진다. `prisma generate` 가 EPERM(엔진 DLL 잠김)이어도 타입·JS 는 재생성된다(같은 버전이면 무시 가능). 곁다리: `src/plugins/` 에 `*.test.ts` 를 두면 autoload·tsup 이 플러그인으로 로드한다(CLAUDE.md 6번 — 앱 연결 테스트는 `src/app.*.test.ts`), 로컬 dev 서버(`tsx watch`)는 **새 라우트 파일을 감지하지 못해** 새 모듈을 붙이면 감시 중인 파일을 touch 하거나 재시작해야 보인다(작업 기록 `4a2bff1`)
- **네이버 구조 개편은 에러 없이 "0건"으로 온다 (27차 `43d7e69`)** — 파서가 옛 키(`Menu:{placeId}_<i>`·`placeDetail.menus`)만 찾다 보니 예외 없이 빈 배열이 됐고, 재크롤이 기존 스냅샷 메뉴까지 `[]` 로 덮었다(배민 연동 가게만 무사). 이제 0건이면 직전 스냅샷을 유지하고 크롤 로그에 warn("메뉴 0건 — 네이버 메뉴 구조 변경 의심")을 남기지만, **직전 스냅샷이 없는 신규 가게는 여전히 메뉴 없이 저장된다** — 그 warn 이 유일한 신호다. 복구는 `backfill:naver-menus`(기본 대상 = 스냅샷 메뉴 0건 네이버 가게). `restaurant_menus` 는 쓰기 전용이라 복구원이 아니다 — [crawl](crawl.md)
- **어드민 맛집 상세 재구성의 남은 어긋남 (27차 `420a6be`, 작업 기록 — 사용자 미결정)** — ① 공개 인사이트(`getInsights`)는 여전히 네이버 행만 집계해, 분석 탭·홈의 'N회 언급'(예: 목살 20)과 출처 통합 리뷰 필터 결과(98)가 어긋난다(공개 화면에도 원래 있던 불일치 — 공개 수치 변경은 사용자 확인 후). ② 상세 헤더의 삭제 버튼은 레거시대로 **네이버 행만** 지우고, 목록 화면 삭제는 canonical 전체다. ③ 화면 육안 확인을 못 했다(브라우저 확장 미연결). 요약 중지·재개·재분석은 경로가 그대로인 채 대상이 canonical 전체로 넓어졌으니 스크립트·외부 호출이 이 어드민 엔드포인트를 쓰고 있었다면 의미가 바뀐다 — [canonical](canonical.md)
...
- **`pnpm --filter friendly test` 는 `.env` 의 운영 스냅샷 DB 를 그대로 쓴다 (사고 이력)** — 격리를 안 쓴 테스트 한 블록이 글로벌 머지 결과 전량을 지웠다(`517e465`, LLM 1,352콜 복구). DB 를 건드리는 테스트는 `useIsolatedDatabase()`(`test-utils/temp-db.ts`, ~~현재 17파일~~ → 27차 **28파일**, 27차에 부팅 정리 함수 테스트가 실 dev.db 대기 요약을 뒤집은 두 번째 사고 — 위 27차 항목) 또는 25차 `useSchemaDatabase()`(`test-utils/schema-db.ts`, 빈 임시 DB `prisma db push`, 7파일 — 사주 C/G·마이그레이션 테스트) 필수. 식단 사진 서비스는 테스트 시 `tmpdir()` 로 보내고, `probe:meal-e2e`·`seed:meal-samples` 는 운영 DB 를 거부한다(`037a4f2`)
- **data.go.kr 키는 하나지만 활용신청은 데이터셋마다 (수정 — 폴백 체인 폐기)** — `DATA_GO_KR_API_KEY` 하나로 버스·에어코리아·기상청·심평원·실거래·K-apt·건축HUB·식약처를 부르며, 그 데이터셋에 활용신청이 없으면 `30 등록되지 않은 서비스키`(키가 틀린 게 아니라 신청 누락), 경로 버전이 틀리면 `12`. 각 `probe:*` 로 먼저 실측. 기상청 API허브 키는 포털 키와 다른 사이트에서 발급. 쿼터는 데이터셋별 — 에어코리아 개발계정 **일 500건**(캐시 TTL 전제), 실거래·건축HUB 10,000, K-apt 5,000, 27차 바다 8종 각 10,000(개발계정 자동승인 — 운영계정 전환은 심의), 인천공항 주차·환경공단 충전기 **1,000**(5·10분 폴러가 하루 ~288콜씩 — 위 dev 서버 이중 폴링 주의). 옛 `BUS_API_KEY` 등 이름은 무시된다. 27차 표준데이터 15012896·서울 열린데이터 `openapi.seoul.go.kr:8088` 은 평문 HTTP 엔드포인트다(MAFRA 와 같은 부류)
...
- **원본 데이터는 리포에 없다 — 새 머신은 `data/open/`(+ `assets-src/`) 부터** — `/data/`·`/assets-src/{tarot,saju}/raw/` 가 gitignore. 적재·프로브가 `data/open/…` 을 기본으로 찾으니 파일이 없으면 "배포본 없음" 으로 끝난다. 어디서 받는지는 docs/data-sources.md 보관표(25차 집값 4행 추가). 평가셋은 재다운로드에 AI Hub 로그인·승인이 필요해 추출본(750장)을 남긴 것 — 원본 16GB zip 은 삭제됨(재추출 코드는 문서에). `--limit` 은 균등 간격 표본(앞에서 자르면 '가~' 클래스만 평가, `5a84b63`). 이미지 원본은 산출물 webp 가 커밋돼 있어 없어도 동작한다(재생성 때만 필요). 27차 예외: `data/open/flood/` 는 비어 있으면 `load:life-flood` 가 서울 열린데이터에서 받아 채우므로 미리 둘 필요가 없고, 주차·바다는 원본 파일 자체가 없다(API)
...
## Sources [coverage: high — 155 sources]

- [README.md](../../README.md)
- [CLAUDE.md](../../CLAUDE.md) — "용어" 섹션 + iOS 링크 오류 안내 문단 (`4228651`) + 핵심 규칙 6번 외부 API 문서(`1b621c4`, 27차)
...
- [.gitignore](../../.gitignore) — `/data/` 공공데이터 원본(`809b7e0`, 27차 주석에 `/data/open/flood/`) + `/assets-src/{tarot,saju}/raw/` 이미지 원본(25차) + 루트 /ios /android /app.json
- [deploy.sh](../../deploy.sh) — 케이스 1~9 + `life_map_data`(27차 침수 흔적 `flood=0` → `load:life-flood`)/`food_catalog_data`/`housing_data`/`parking_data`(27차) 자동 점검 + `stat_val` + K-apt glob 탐지 (`5a84b63`·`dae1cc9`·`4fd6e22`·`254fb76`·`b8c08ed`·`ad48f96`·`2ff2c31`) — 머리 주석은 아직 1~8
...
- [docs/data-sources.md](../../docs/data-sources.md) — 원본 데이터 운영 가이드: 원칙·보관표(25차 집값 4행·원재료 DB·큐레이션)·집값 보강 적재 순서·fatsecret 실측·평가셋·백업·테스트 격리 경고 + 27차 flood 행(OA-15636·자동 다운로드·43,112점)·바다 "API 만" 문단(주차는 없음)
- [docs/api/README.md](../../docs/api/README.md) — 외부 사용 가이드(수기, 27차 `1b621c4`): 기준 URL·CORS·인증 3등급·에러 본문·레이트리밋/일일 한도·도메인 개요·데이터 이용 조건·openapi-typescript·알려진 한계 — 파일 표 "183개"·주차 부재는 낡음
- [docs/api/endpoints.md](../../docs/api/endpoints.md) — 자동 생성 엔드포인트 색인(192개: 공개 83·선택 15·로그인 94, 27차 `2ff2c31` 재생성)
- [docs/api/openapi.json](../../docs/api/openapi.json) — 자동 생성 OpenAPI 3(경로 159·operation 192, 53,919줄, 27차)
- [docs/PLAN-parking.md](../../docs/PLAN-parking.md) — 주차 결정 표·원천 7행·호출량(폴러 288콜/일·dev 서버 이중 폴링)·구조·차수 1~5·함정 (27차)
- [docs/PLAN-perf-security.md](../../docs/PLAN-perf-security.md) — 보안·성능 감사 계획 — #42 CORS fail-closed 의 2026-09-24 번복 문단·#44 Swagger dev 전용 (27차 기록)
...
- [apps/friendly/.env.example](../../apps/friendly/.env.example) — `DATA_GO_KR_API_KEY` 하나 + 데이터셋별 활용신청 주석 · `HOUSING_REFRESH_{CRON,MONTHS}` · `OLLAMA_{TAROT,SAJU,SAJU_G,MENU_MATCH}_MODEL` 프로브 근거 주석 · 운영 도메인/OG 키 (25차 수정) · 27차: `CORS_ORIGIN=*`(주석 — 어드민 외·prod 만) · 바다 8·주차 4 활용신청 주석 · `PARKING_LIVE_CRON`·`EV_STATUS_CRON` · `SEOUL_OPEN_API_KEY`(처음 등재)
- [apps/friendly/src/config/env.ts](../../apps/friendly/src/config/env.ts) — env 검증 스키마: `DATA_GO_KR_API_KEY`(`3d9dfed`, 27차 주석에 바다·주차 — 이 키에 걸린 데이터셋 25개) · `KMA_APIHUB_KEY` · `HOUSING_*` · `PARKING_LIVE_CRON`·`EV_STATUS_CRON`(27차) · `CORS_ORIGIN`(기본 `*`)·`PUBLIC_ORIGIN` · purpose 모델 8종 · `MEAL_*` · APP_TEAM_ID / WEB_INDEX_PATH / OG_IMAGE_PATH · `isTest`
- [apps/friendly/package.json](../../apps/friendly/package.json) — 스크립트 ~~92개~~ → **107개**(25차 +25: build/measure 접두, housing load/status, probe 9 / 26차 +9 / 27차 +6: `export:openapi`·`backfill:naver-menus`·`load:life-flood`·`load:parking-lots`·`load:ev-chargers`·`status:parking`) · croner / satori / @resvg/resvg-js / lru-cache · astronomy-engine(dev) — 27차 새 의존성 없음
- [apps/friendly/vitest.config.ts](../../apps/friendly/vitest.config.ts) — `fileParallelism: false` + 27차 `hookTimeout: 60_000`(격리 DB 준비, `5d7b686`)
- [apps/friendly/scripts/export-openapi.ts](../../apps/friendly/scripts/export-openapi.ts) — `buildApp` → `app.ready()` → `app.swagger()` → 어드민·HTML 제외 → `docs/api/openapi.json`·`endpoints.md` (27차)
- [apps/friendly/scripts/load-life-flood.ts](../../apps/friendly/scripts/load-life-flood.ts) — 침수흔적도 적재(폴더 비면 자동 다운로드, `--download`·`--refresh`·`--dry-run`) (27차)
- [apps/friendly/scripts/load-parking-lots.ts](../../apps/friendly/scripts/load-parking-lots.ts) · [load-ev-chargers.ts](../../apps/friendly/scripts/load-ev-chargers.ts) · [parking-status.ts](../../apps/friendly/scripts/parking-status.ts) — 주차장(표준 ~19콜 + 서울 공영 + 지오코딩)·충전소(~53콜) 전량 교체, 상태 한 줄 (27차)
- [apps/friendly/scripts/backfill-naver-menus.ts](../../apps/friendly/scripts/backfill-naver-menus.ts) — 네이버 메뉴만 재수집(리뷰 무변경) (27차 `43d7e69`)
- [apps/friendly/scripts/](../../apps/friendly/scripts/) — ~~78 파일~~ → 93 파일(26차 87, 27차 +6) — 25차 신규: `build-tarot-deck.ts` · `build-saju-{tables,images,glyphs}.ts` · `probe-{tarot,saju,saju-g}-reading.ts` · `probe-saju-g-pair.ts` · `load-housing-{complexes,trades,prices,kapt,buildings}.ts` · `housing-status.ts` · `geocode-housing-missing.ts` · `rebuild-housing-derived.ts` · `probe-rtms-api.ts` · `measure-menu-{nutrition,golden,decompose}.ts` · `probe-menu-{coverage,resolve,decompose}.ts` · `probe-food-web-estimate.ts` · `fetch-mfds-nutrition.ts` (25차 신규)
- [apps/friendly/scripts/life-map-status.ts](../../apps/friendly/scripts/life-map-status.ts) + [food-catalog-status.ts](../../apps/friendly/scripts/food-catalog-status.ts) — deploy.sh 가 파싱하는 한 줄 상태 (27차 `flood=F` 추가)
...
- [apps/friendly/src/test-utils/temp-db.ts](../../apps/friendly/src/test-utils/temp-db.ts) — `useIsolatedDatabase()` (~~17파일~~ → 27차 28파일 — dev.db 통째 복사)
- [apps/friendly/src/app.cors.test.ts](../../apps/friendly/src/app.cors.test.ts) · [app.openapi.test.ts](../../apps/friendly/src/app.openapi.test.ts) · [app.errors.test.ts](../../apps/friendly/src/app.errors.test.ts) — 앱 연결 테스트 7·5·2 케이스(`src/plugins/` 밖에 두는 규칙, 27차)
- [apps/friendly/src/modules/summary/summary.test.ts](../../apps/friendly/src/modules/summary/summary.test.ts) — `cleanupStaleReviewSummaries`·재큐잉·`summaryChannelKey` 테스트를 격리 DB 로(27차 `420a6be`)
- [apps/friendly/src/modules/meal-recognition/meal-recognition.service.test.ts](../../apps/friendly/src/modules/meal-recognition/meal-recognition.service.test.ts) — `beforeAll` 테스트 사용자 생성(FK, 27차 `5d7b686`)
...
- [apps/friendly/src/plugins/rate-limit.ts](../../apps/friendly/src/plugins/rate-limit.ts) — `RATE` 프리셋(tarotShare 10/분·housingRead 240·housingSearch 120·27차 **parkingRead 240**, 바다는 transitRealtime 60) + `clientKey`(cf-connecting-ip 우선) (25·27차 수정)
- [apps/friendly/src/plugins/swagger.ts](../../apps/friendly/src/plugins/swagger.ts) — 스펙 생성기 전 환경·`/docs` dev 만·transform(`x-auth`·`x-rate-limit`·bearer)·`OPTIONAL_BEARER` (27차 `1b621c4`)
- [apps/friendly/src/plugins/error-handler.ts](../../apps/friendly/src/plugins/error-handler.ts) — 레이트리밋 평객체 429 본문 `error` 유지 (27차 `678ecc0`)
- [apps/friendly/src/modules/housing/](../../apps/friendly/src/modules/housing/) — rtms/kapt/bldg-hub/datago-json 어댑터, 단지·거래·공시가격·K-apt·건축물 마스터, 파생·지오코딩·ingest·refresh(croner, route `onReady` 기동)·route (25차 신규)
- [apps/friendly/src/modules/housing/housing-flood.service.ts](../../apps/friendly/src/modules/housing/housing-flood.service.ts) — `HousingFloodIndex` 침수 흔적 메모리 격자(반경 100m, 커버리지 밖 null) (27차 `ad48f96`)
- [apps/friendly/src/modules/life-map/life-flood-master.service.ts](../../apps/friendly/src/modules/life-map/life-flood-master.service.ts) — 서울 침수흔적도 SHP/DBF 파서 → `LifeFloodTrace` (27차)
- [apps/friendly/src/modules/sea/](../../apps/friendly/src/modules/sea/) — 바다 khoa.adapter·sea.service(메모리 캐시·stale)·sea.route·sea.test — 적재 없음 (27차 `4a2bff1`)
- [apps/friendly/src/modules/parking/](../../apps/friendly/src/modules/parking/) — 주차 12파일(어댑터·주차장/충전소 마스터·실시간/상태 폴러·서비스·route·테스트 4) (27차 `2ff2c31`)
- [apps/friendly/src/modules/parking/parking.route.ts](../../apps/friendly/src/modules/parking/parking.route.ts) — 폴러 `onListen` 시작·`isTest` 면 cron 빈 값·`onClose` stop (27차)
- [apps/friendly/src/modules/crawl/adapters/naver-place.playwright.adapter.ts](../../apps/friendly/src/modules/crawl/adapters/naver-place.playwright.adapter.ts) · [crawl.service.ts](../../apps/friendly/src/modules/crawl/crawl.service.ts) — `placeMenus` 파서·`/menu/list` 조건부·메뉴 0건 보호·warn (27차 `43d7e69`)
- [apps/friendly/src/modules/restaurant/restaurant.service.ts](../../apps/friendly/src/modules/restaurant/restaurant.service.ts) · [restaurant.route.ts](../../apps/friendly/src/modules/restaurant/restaurant.route.ts) — 메뉴 가게 단위 통째 교체·어드민 상세 canonical 전체 리뷰·`review-match`·`filterReviewsByTipMenu` (27차 `43d7e69`·`420a6be`)
- [apps/friendly/src/modules/summary/summary.service.ts](../../apps/friendly/src/modules/summary/summary.service.ts) — `summaryChannelKey`·canonical 전체 중지/재개/재분석·부팅 정리/재큐잉 (27차 `420a6be`)
...
- [apps/friendly/prisma/schema.prisma](../../apps/friendly/prisma/schema.prisma) — ~~93~~ → **113 모델**(26차 +14: Tour* 10·RestaurantTourMatch·TourPlaceBizStatus·LifeStore·RestaurantStoreMatch / 27차 +6: LifeFloodTrace·ParkingLot·ParkingOccupancyStat·ParkingSync·EvStation·EvCharger) (25차 +18: Housing 6·MenuLexicon/MenuLlmMatch/MenuLlmDecomposition/FoodWebEstimate·TarotReading·UsageQuotaSetting/Counter·SajuProfile/SajuReading·SajuGProfile/Reading/Share) + 정산 모델(`SettlementRound` JSON 컬럼·`SettlementDraft`)
- [apps/friendly/prisma/migrations/](../../apps/friendly/prisma/migrations/) — 총 ~~80~~ → **88**. 27차 2개: `20260924080000_add_life_flood_traces` · `20260925071552_add_parking`(둘 다 CREATE 만). 26차 6개: `20260912101013_add_life_store_and_restaurant_store_match` · `20260912102150_drop_restaurant_store_match_store_fk` · `20260912120000_add_llm_provider_thinking` · `20260913062022_add_tour_log` · `20260913064102_add_tour_match_biz` · `20260915185047_add_tour_dataset_multi`. 25차 11개: `20260830094116_add_housing` · `20260830112334_add_housing_enrich` · `20260902120000_add_food_kcal_per_100g` · `20260902150000_add_menu_llm_match` · `20260902170000_add_food_web_estimate` · `20260903090000_add_menu_lexicon` · `20260903100000_add_menu_llm_decomposition` · `20260903120000_add_tarot_reading_and_usage_quota` · `20260903130000_add_tarot_share_question` · `20260906110442_add_saju_profile_and_reading` · `20260906170000_add_saju_g`
...
- [packages/api-contract/src/routes.ts](../../packages/api-contract/src/routes.ts) — 27차 `Routes.Sea`(forecast·tide)·`Routes.Parking`(9)·`Restaurant.reviewMatch` / 26차 `Routes.Tour`·`LifeMap.crime` / `Routes.Housing/Tarot/Saju(/saju-c)/SajuG/UsageQuota` + `publicMenuNutrition`·`adminMenuLexicon` (25차) / AirQuality/Weather/LifeMap/Food/Meal / Settlement(PUT)·SettlementDraft·WellKnown·Ai.modelsPreview
- [packages/api-contract/src/schemas/](../../packages/api-contract/src/schemas/) — ~~43개~~ → **46개**(26차 +tour, 27차 +sea(107줄)·parking(377줄), housing `flood`·restaurant `AdminVisitorReview`/`canonicalId`/`sources` 수정) (25차 +7: tarot/saju/saju-g/housing/usage-quota/menu-lexicon/menu-nutrition + ai purpose 8종)
...
- [packages/shared/src/](../../packages/shared/src/) — ~~api 43 / hooks 47~~ → api 46 / hooks 50 / stores 30(테스트 포함 파일 수, 27차 +sea.api·parking.api·useSea·useParking, useRestaurant canonical 요약 이벤트·review-match 훅, summarySseManager·resummarizeStore 수정) (25차 +tarot·saju·saju-g·housing·usage-quota api/hooks, `useSajuJob` long-poll) + air-quality·weather·life-map·food·meal
- [packages/shared/src/hooks/useSchedule.ts](../../packages/shared/src/hooks/useSchedule.ts) — schedule API/훅
- [packages/utils/src/](../../packages/utils/src/) — ~~49 파일~~ → 59 파일 + 테스트 34(27차 +lifeFlood·parking·parkingMarker·sea·seaStations, geo UTM-K 변환, 26차 +tourLog·lifeCrime·lifeStore·sajuThemes·sajuAsk) (25차 +tarot·tarotCards·tarotFlow·tarotMenu / saju·sajuCalendar·sajuAstroTable(생성물)·sajuText·sajuDaily·sajuMatch·sajuDatePick·sajuFood·sajuFlow·sajuImages·sajuInsights·sajuDayPillar / saju-g·saju-g-stories / housing·housingMarker·thumbnail, aiModel purpose 확장)
- [apps/web/src/App.tsx](../../apps/web/src/App.tsx) — `/housing`·`/tarot(/s/:token)`·`/saju-c(/s/:token)`·`/saju-g(/pair|/s/:token)`·`/me/{tarot,saju-c,saju-g(/profiles)}` lazy 라우트 (25차 수정) + `/sea`·`/parking` lazy (27차)
- [apps/web/src/routes/SeaPage.tsx](../../apps/web/src/routes/SeaPage.tsx) · [ParkingPage.tsx](../../apps/web/src/routes/ParkingPage.tsx) · [stores/parkingPrefsStore.ts](../../apps/web/src/stores/parkingPrefsStore.ts) — 바다(그리드·URL 상태) / 주차(시트 골격·URL 상태·`lp:parking-prefs`) (27차)
- [apps/web/src/components/restaurant/detail/ParkingSection.tsx](../../apps/web/src/components/restaurant/detail/ParkingSection.tsx) — 맛집 '가는 법' 주차 섹션 (27차)
- [apps/web/src/routes/admin/AdminRestaurantDetailPage.tsx](../../apps/web/src/routes/admin/AdminRestaurantDetailPage.tsx) + [components/admin/restaurant-detail/](../../apps/web/src/components/admin/restaurant-detail/tabs.ts) — 어드민 맛집 상세 재구성(탭 9 — '가는 법' 제외, '여행자' 는 매칭 시) (27차 `420a6be`)
...
- [apps/web/src/components/PublicSidebar.tsx](../../apps/web/src/components/PublicSidebar.tsx) — NAV ~~10개~~ → 27차 13개 + 로그인 시 식단(주차 `SquareParking`·바다 `Waves` 아이콘) 순서 + 하단 계정·테마 섹션 (`69ed65f`·`a062e7d`, 25차 타로·사주(C)·사주(G)·집값, 26차 여행, 27차 주차·바다 추가)
- [apps/web/src/components/PublicTopBar.tsx](../../apps/web/src/components/PublicTopBar.tsx) (별도 NAV 배열 — 27차 같이 수정, 폭 예산 메모는 "NAV 7개"로 낡음) + [AccountMenu.tsx](../../apps/web/src/components/AccountMenu.tsx) + [PublicLayout.tsx](../../apps/web/src/components/PublicLayout.tsx) + [weather/MyLocationChip.tsx](../../apps/web/src/components/weather/MyLocationChip.tsx) — 폭 예산·계정 메뉴("내 타로 기록")·임베드 크롬 생략·통합 알약
...
- [apps/friendly/src/server.ts](../../apps/friendly/src/server.ts) — listen 전 순차 bootstrap(요약 stale 정리 → 재큐잉 → schedule → 텔레그램 → 자동 발굴 → 카탈로그 잡) + SIGTERM stopAllCrons/abortInflight + 15초 안전망 — 27차 "시작 지점" 표의 원천
- [apps/friendly/src/plugins/summaries.ts](../../apps/friendly/src/plugins/summaries.ts) — 전역 SummaryService + `onReady` 군집 기동 리컨실(unref 지연) (27차 시작 지점 비교)
...
- [apps/friendly/src/plugins/cors.ts](../../apps/friendly/src/plugins/cors.ts) — ~~dev 전면 origin 반사 허용~~ → 27차 `buildCorsPolicy`·`isAdminPath`: 어드민 외 `*`·어드민 `PUBLIC_ORIGIN`·credentials false·노출 헤더·preflight 600초 (`1b621c4`)
