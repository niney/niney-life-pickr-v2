...
Total topics: 10 | Total concepts: 4 | Mode: codebase
...
| [friendly](topics/friendly.md) | fastify-api, backend, prisma-server, jwt-auth | 30 | 2026-05-07 | active |
...
| [web](topics/web.md) | vite, react, web-app, frontend-web | 24 | 2026-05-07 | active |
| [mobile](topics/mobile.md) | expo, react-native, expo-router, eas, ios, android | 15 | 2026-05-07 | active |
| [api-contract](topics/api-contract.md) | zod, schemas, ssot, contracts, @repo/api-contract | 11 | 2026-05-07 | active |
| [shared](topics/shared.md) | react-query, zustand, design-tokens, ui-primitives, @repo/shared | 27 | 2026-05-07 | active |
...
- **횡단 패턴** → [concepts/](concepts/) 디렉터리 — Zod SSOT 인프라, SSE 인증, UI 플랫폼 분기, workspace 패키지 해결 체인
