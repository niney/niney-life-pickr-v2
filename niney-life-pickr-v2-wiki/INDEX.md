...
| [friendly](topics/friendly.md) | fastify-api, backend, prisma-server, jwt-auth, restaurant-module, summary-module, media-module, thumbnail-proxy | 42 | 2026-05-08 | active |
| [crawl](topics/crawl.md) | naver-place, scraping, playwright, sse-jobs, job-queue, visitor-videos, review-sort | 11 | 2026-05-08 | active |
| [ai](topics/ai.md) | llm, ollama, ollama-cloud, llm-provider, ai-keys, ai-test, completion, completeBatch, structured-output, json-schema, num_ctx, retry-backoff | 13 | 2026-05-08 | active |
| [web](topics/web.md) | vite, react, web-app, frontend-web, admin-restaurants, active-job-panel, video-modal, sentiment-badge, sort-dropdown | 28 | 2026-05-08 | active |
| [mobile](topics/mobile.md) | expo, react-native, expo-router, eas, ios, android | 15 | 2026-05-07 | active |
| [api-contract](topics/api-contract.md) | zod, schemas, ssot, contracts, @repo/api-contract, restaurant-schemas, visitor-review-video, review-analysis | 12 | 2026-05-08 | active |
| [shared](topics/shared.md) | react-query, zustand, design-tokens, ui-primitives, @repo/shared, summary-sse-manager, active-crawl-job-store, useRestaurant | 31 | 2026-05-08 | active |
...
| [stream-driven-cache-merge](concepts/stream-driven-cache-merge.md) | crawl, friendly, shared, web | 2026-05-08 |
| [in-memory-singleton-gates](concepts/in-memory-singleton-gates.md) | ai, crawl, friendly, shared | 2026-05-08 |
