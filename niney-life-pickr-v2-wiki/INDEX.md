...
Total topics: 12 | Total concepts: 7 | Mode: codebase
...
|-------|--------------|---------|-------------|--------|
| [project-overview](topics/project-overview.md) | monorepo, life-pickr, niney, root, turbo, pnpm-workspace | 7 | 2026-05-09 | active |
| [friendly](topics/friendly.md) | fastify-api, backend, prisma-server, jwt-auth, restaurant-module, summary-module, media-module, analytics-module, menu-grouping-module, thumbnail-proxy | 50 | 2026-05-09 | active |
...
| [web](topics/web.md) | vite, react, web-app, frontend-web, admin-restaurants, admin-analytics, ai-analysis-management, active-job-panel, video-modal, sentiment-badge, MenuRankingSection, GlobalCompareBadge, CategoryTreeSection | 30 | 2026-05-09 | active |
...
| [api-contract](topics/api-contract.md) | zod, schemas, ssot, contracts, @repo/api-contract, restaurant-schemas, visitor-review-video, review-analysis, MenuRankingItem, GlobalMenuStat, CategoryTreeNode, z-lazy | 14 | 2026-05-09 | active |
| [shared](topics/shared.md) | react-query, zustand, design-tokens, ui-primitives, @repo/shared, summary-sse-manager, useMenuRanking, useGroupingJob, useGlobalMergeJob, useCategoryTree | 35 | 2026-05-09 | active |
...
|---------|----------|-------------|
| [zod-ssot-buildless](concepts/zod-ssot-buildless.md) | api-contract, friendly, shared, web, mobile, utils, project-overview, ai, menu-grouping, analytics | 2026-05-09 |
...
- **횡단 패턴** → [concepts/](concepts/) 디렉터리 — Zod SSOT 인프라, SSE 인증, UI 플랫폼 분기, workspace 패키지 해결, 스트림 캐시 머지, 인메모리 게이트, LLM 프롬프트 버전
